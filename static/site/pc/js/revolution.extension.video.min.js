  ...
  jQuery.extend(!0, a, {
    ...
    prepareCoveredVideo: function (e, t, i) {
      var d = i.find('iframe, video'),
        ...
        u = (s / l) * 100,
        p = (l / s) * 100;
      (s > l ? punchgs.TweenLite.to(d, 0.001, { height: u + '%', width: '100%', top: -(u - 100) / 2 + '%', left: '0px', position: 'absolute' }) : punchgs.TweenLite.to(d, 0.001, { width: p + '%', height: '100%', left: -(p - 100) / 2 + '%', top: '0px', position: 'absolute' }),
      ...
      switch (((w = e.data('nextslideatend') === !0 ? '' : w), e.data('videotype', T), x)) {
        case 'html5':
          ...
          (('true' === y || y === !0) && (V = '<div class="tp-video-button-wrap"><button  type="button" class="tp-video-button tp-vid-full-screen">Full-Screen</button></div>'),
            'controls' == h && (L += '<div class="tp-video-controls"><div class="tp-video-button-wrap"><button type="button" class="tp-video-button tp-vid-play-pause">Play</button></div><div class="tp-video-seek-bar-wrap"><input  type="range" class="tp-seek-bar" value="0"></div><div class="tp-video-button-wrap"><button  type="button" class="tp-video-button tp-vid-mute">Mute</button></div><div class="tp-video-vol-bar-wrap"><input  type="range" class="tp-volume-bar" min="0" max="1" step="0.1" value="1"></div>' + V + '</div>'),
            e.data('videomarkup', L),
            e.append(L),
            ((i && 1 == e.data('disablevideoonmobile')) || a.isIE(8)) && e.find(k).remove(),
          ...
          0 == e.find('iframe').length &&
            e.find('.tp-videoposter').click(function () {
              if ((a.playVideo(e, o), i)) {
                ...
                (punchgs.TweenLite.to(e.find('.tp-videoposter'), 0.3, { autoAlpha: 0, force3D: 'auto', ease: punchgs.Power3.easeInOut }), punchgs.TweenLite.to(e.find('iframe'), 0.3, { autoAlpha: 1, display: 'block', ease: punchgs.Power3.easeInOut }));
              }
            }));
      else {
        if (i && 1 == e.data('disablevideoonmobile')) return !1;
  ...
  var d = function (e, t, a) {
            ...
            var f = new YT.Player(v, {
              events: {
                onStateChange: function (i) {
                  ...
                  if (i.data == YT.PlayerState.PLAYING) (punchgs.TweenLite.to(e.find('.tp-videoposter'), 0.3, { autoAlpha: 0, force3D: 'auto', ease: punchgs.Power3.easeInOut }), punchgs.TweenLite.to(e.find('iframe'), 0.3, { autoAlpha: 1, display: 'block', ease: punchgs.Power3.easeInOut }), 'mute' == e.data('volume') || a.lastToggleState(e.data('videomutetoggledby')) || d.globalmute === !0 ? f.mute() : (f.unMute(), f.setVolume(parseInt(e.data('volume'), 0) || 75)), (d.videoplaying = !0), u(e, d), g ? d.c.trigger('stoptimer') : (d.videoplaying = !1), d.c.trigger('revolution.slide.onvideoplay', o(f, 'youtube', e.data())), a.toggleState(e.data('videotoggledby')));
                  else {
                    if (0 == i.data && c) {
                      var v = t(e.data('videostartat'));
                      (-1 != v && f.seekTo(v), f.playVideo(), a.toggleState(e.data('videotoggledby')));
                    }
                    (!l && (0 == i.data || 2 == i.data) && 'on' == e.data('showcoveronpause') && e.find('.tp-videoposter').length > 0 && (punchgs.TweenLite.to(e.find('.tp-videoposter'), 0.3, { autoAlpha: 1, force3D: 'auto', ease: punchgs.Power3.easeInOut }), punchgs.TweenLite.to(e.find('iframe'), 0.3, { autoAlpha: 0, ease: punchgs.Power3.easeInOut })), -1 != i.data && 3 != i.data && ((d.videoplaying = !1), (d.tonpause = !1), p(e, d), r.trigger('starttimer'), d.c.trigger('revolution.slide.onvideostop', o(f, 'youtube', e.data())), (void 0 == d.currentLayerVideoIsPlaying || d.currentLayerVideoIsPlaying.attr('id') == e.attr('id')) && a.unToggleState(e.data('videotoggledby'))), 0 == i.data && 1 == e.data('nextslideatend') ? (n(), e.data('nextslideatend-triggered', 1), d.c.revnext(), p(e, d)) : (p(e, d), (d.videoplaying = !1), r.trigger('starttimer'), d.c.trigger('revolution.slide.onvideostop', o(f, 'youtube', e.data())), (void 0 == d.currentLayerVideoIsPlaying || d.currentLayerVideoIsPlaying.attr('id') == e.attr('id')) && a.unToggleState(e.data('videotoggledby'))));
                  }
                },
                onReady: function (a) {
            ...
            x.addEvent('ready', function () {
              if (
                ...
                x.addEvent('play', function (t) {
                  (e.data('nextslidecalled', 0), punchgs.TweenLite.to(e.find('.tp-videoposter'), 0.3, { autoAlpha: 0, force3D: 'auto', ease: punchgs.Power3.easeInOut }), punchgs.TweenLite.to(e.find('iframe'), 0.3, { autoAlpha: 1, display: 'block', ease: punchgs.Power3.easeInOut }), d.c.trigger('revolution.slide.onvideoplay', o(x, 'vimeo', e.data())), (d.videoplaying = !0), u(e, d), g ? d.c.trigger('stoptimer') : (d.videoplaying = !1), 'mute' == e.data('volume') || a.lastToggleState(e.data('videomutetoggledby')) || d.globalmute === !0 ? x.api('setVolume', '0') : x.api('setVolume', parseInt(e.data('volume'), 0) / 100 || 0.75), a.toggleState(e.data('videotoggledby')));
                }),
                ...
                x.addEvent('pause', function (t) {
                  (e.find('.tp-videoposter').length > 0 && 'on' == e.data('showcoveronpause') && (punchgs.TweenLite.to(e.find('.tp-videoposter'), 0.3, { autoAlpha: 1, force3D: 'auto', ease: punchgs.Power3.easeInOut }), punchgs.TweenLite.to(e.find('iframe'), 0.3, { autoAlpha: 0, ease: punchgs.Power3.easeInOut })), (d.videoplaying = !1), (d.tonpause = !1), p(e, d), d.c.trigger('starttimer'), d.c.trigger('revolution.slide.onvideostop', o(x, 'vimeo', e.data())), (void 0 == d.currentLayerVideoIsPlaying || d.currentLayerVideoIsPlaying.attr('id') == e.attr('id')) && a.unToggleState(e.data('videotoggledby')));
                }),
                e.find('.tp-videoposter').unbind('click'),
                e.find('.tp-videoposter').click(function () {
    ...
    l = function (e, r, l) {
      ...
      if (
        ...
        m.data('metaloaded', 1),
        1 != e.data('bgvideo') || ('none' !== e.data('videoloop') && e.data('videoloop') !== !1) || (y = !1),
      ...
      (void 0 != b &&
        ...
        d(g, 'timeupdate', function () {
          var a = (100 / g.duration) * g.currentTime,
            ...
            d = g.currentTime;
          if ((void 0 != k && (k.value = a), 0 != i && -1 != i && Math.abs(i - d) <= 0.3 && i > d && 1 != e.data('nextslidecalled')))
            if (f) {
              g.play();
              var o = t(e.data('videostartat'));
              -1 != o && (g.currentTime = o);
        ...
        d(g, 'play', function () {
          ...
          (u(e, r), y && 'audio' != i ? ((r.videoplaying = !0), r.c.trigger('stoptimer'), r.c.trigger('revolution.slide.onvideoplay', o(g, 'html5', e.data()))) : ((r.videoplaying = !1), 'audio' != i && r.c.trigger('starttimer'), r.c.trigger('revolution.slide.onvideostop', o(g, 'html5', e.data()))), punchgs.TweenLite.to(e.find('.tp-videoposter'), 0.3, { autoAlpha: 0, force3D: 'auto', ease: punchgs.Power3.easeInOut }), punchgs.TweenLite.to(e.find(i), 0.3, { autoAlpha: 1, display: 'block', ease: punchgs.Power3.easeInOut }));
        ...
        d(g, 'pause', function () {
          var t = 'html5' == e.data('audio') ? 'audio' : 'video',
            i = s();
          (!i && e.find('.tp-videoposter').length > 0 && 'on' == e.data('showcoveronpause') && !e.hasClass('seekbardragged') && (punchgs.TweenLite.to(e.find('.tp-videoposter'), 0.3, { autoAlpha: 1, force3D: 'auto', ease: punchgs.Power3.easeInOut }), punchgs.TweenLite.to(e.find(t), 0.3, { autoAlpha: 0, ease: punchgs.Power3.easeInOut })), e.removeClass('videoisplaying'), (r.videoplaying = !1), p(e, r), 'audio' != t && r.c.trigger('starttimer'), r.c.trigger('revolution.slide.onvideostop', o(g, 'html5', e.data())));
          var d = e.find('.tp-vid-play-pause')[0];
