...
function tsChangge(e, t) {
	e && (isSimplified = isSimplified ? 0 : 1), metFileLoadFun(M.weburl +
...
function metui(e) {
	for (var t in e) "string" == typeof e[t] && "name" == t ? METUI[e[t]] = $("." + e[t]) : "function" == typeof e[t] && e[
		t]()
}
if (function(e, t) {
		...
		function n(e) {
			var t = !!e && "length" in e && e.length,
				n = re.type(e);
			return "function" !== n && !re.isWindow(e) && ("array" === n || 0 === t || "number" == typeof t && t > 0 && t - 1 in
				e)
		}
		...
		function l(e, t, n) {
			...
			if (void 0 === n && 1 === e.nodeType)
				if (i = "data-" + t.replace(Ae, "-$&").toLowerCase(), "string" == typeof(n = e.getAttribute(i))) {
					try {
						n = "true" === n || "false" !== n && ("null" === n ? null : +n + "" === n ? +n : Te.test(n) ? re.parseJSON(n) :
							n)
					} catch (e) {}
					Ce.set(e, t, n)
				} else n = void 0;
		...
		function c(e, t) {
			var n = void 0 !== e.getElementsByTagName ? e.getElementsByTagName(t || "*") : void 0 !== e.querySelectorAll ? e.querySelectorAll(
				t || "*") : [];
		...
		function d(e, t, n, i, r) {
			for (var o, s, a, l, u, d, h = t.createDocumentFragment(), p = [], g = 0, v = e.length; v > g; g++)
				...
				for (s = s || h.appendChild(t.createElement("div")), a = (Ne.exec(o) || ["", ""])[1].toLowerCase(), l = Le[a] ||
					Le._default, s.innerHTML = l[1] + re.htmlPrefilter(o) + l[2], d = l[0]; d--;) s = s.lastChild;
		...
		function m(e, t) {
			return re.nodeName(e, "table") && re.nodeName(11 !== t.nodeType ? t : t.firstChild, "tr") ? e.getElementsByTagName(
		...
		function w(e, t) {
			...
			"input" === n && De.test(e.type) ? t.checked = e.checked : "input" !== n && "textarea" !== n || (t.defaultValue = e
				.defaultValue)
		}
		...
		function E(e, t, n, i) {
			...
			if (h && (r = d(t, e[0].ownerDocument, !1, e, i), o = r.firstChild, 1 === r.childNodes.length && (r = o), o || i)) {
				for (s = re.map(c(r, "script"), y), a = s.length; h > f; f++) l = r, f !== p && (l = re.clone(l, !0, !0), a && re.merge(
					s, c(l, "script"))), n.call(e[f], l, f);
				if (a)
					for (u = s[s.length - 1].ownerDocument, re.map(s, b), f = 0; a > f; f++) l = s[f], je.test(l.type || "") && !xe.access(
						l, "globalEval") && re.contains(u, l) && (l.src ? re._evalUrl && re._evalUrl(l.src) : re.globalEval(l.textContent
						.replace(Be, "")))
			}
			return e
		}
		...
		function T(e) {
			var t = K,
				n = Ve[e];
			return n || (n = C(e, t), "none" !== n && n || (Ue = (Ue || re("<iframe frameborder='0' width='0' height='0'/>")).appendTo(
				t.documentElement), t = Ue[0].contentDocument, t.write(), t.close(), n = C(e, t), Ue.detach()), Ve[e] = n), n
		}

		function A(e, t, n) {
			var i, r, o, s, a = e.style;
			return n = n || Qe(e), s = n ? n.getPropertyValue(t) || n[t] : void 0, "" !== s && void 0 !== s || re.contains(e.ownerDocument,
					e) || (s = re.style(e, t)), n && !ie.pixelMarginRight() && Ge.test(s) && ze.test(t) && (i = a.width, r = a.minWidth,
					o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o),
				void 0 !== s ? s + "" : s
		}
		...
		function O(e, t, n, i, r) {
			for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, s = 0; 4 > o; o += 2) "margin" === n &&
				(s += re.css(e, n + Ie[o], !0, r)), i ? ("content" === n && (s -= re.css(e, "padding" + Ie[o], !0, r)), "margin" !==
					n && (s -= re.css(e, "border" + Ie[o] + "Width", !0, r))) : (s += re.css(e, "padding" + Ie[o], !0, r), "padding" !==
					n && (s += re.css(e, "border" + Ie[o] + "Width", !0, r)));
			return s
		}
		...
		function N(e, t) {
			for (var n, i, r, o = [], s = 0, a = e.length; a > s; s++) i = e[s], i.style && (o[s] = xe.get(i, "olddisplay"), n =
				i.style.display, t ? (o[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Oe(i) && (o[s] =
					xe.access(i, "olddisplay", T(i.nodeName)))) : (r = Oe(i), "none" === n && r || xe.set(i, "olddisplay", r ? n :
					re.css(i, "display"))));
		...
		function R(e, t, n) {
			var i, r, o, s, a, l, u, c = this,
				...
				h = e.nodeType && Oe(e),
				p = xe.get(e, "fxshow");
			n.queue || (a = re._queueHooks(e, "fx"), null == a.unqueued && (a.unqueued = 0, l = a.empty.fire, a.empty.fire =
				function() {
					a.unqueued || l()
				...
				u = re.css(e, "display"), "inline" === ("none" === u ? xe.get(e, "olddisplay") || T(e.nodeName) : u) && "none" ===
				re.css(e, "float") && (d.display = "inline-block")), n.overflow && (d.overflow = "hidden", c.always(function() {
			...
			if (re.isEmptyObject(f)) "inline" === ("none" === u ? T(e.nodeName) : u) && (d.display = u);
				...
				p ? "hidden" in p && (h = p.hidden) : p = xe.access(e, "fxshow", {}), o && (p.hidden = !h), h ? re(e).show() : c.done(
					function() {
						re(e).hide()
					}), c.done(function() {
					var t;
				...
				for (i in f) s = M(h ? p[i] : 0, i, c), i in p || (p[i] = s.start, h && (s.end = s.start, s.start = "width" === i ||
					"height" === i ? 1 : 0))
			}
		}
		...
		function H(e, t) {
			var n, i, r, o, s;
			for (n in e)
				if (i = re.camelCase(n), r = t[i], o = e[n], re.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o,
						delete e[n]), (s = re.cssHooks[i]) && "expand" in s) {
		...
		function F(e, t, n) {
			var i, r, o = 0,
				...
				l = function() {
					if (r) return !1;
					for (var t = nt || L(), n = Math.max(0, u.startTime + u.duration - t), i = n / u.duration || 0, o = 1 - i, s = 0,
							l = u.tweens.length; l > s; s++) u.tweens[s].run(o);
			...
			for (H(c, u.opts.specialEasing); s > o; o++)
				if (i = F.prefilters[o].call(u, e, c, u.opts)) return re.isFunction(i.stop) && (re._queueHooks(u.elem, u.opts.queue)
		...
		function W(e) {
			return function(t, n) {
				...
				if (re.isFunction(n))
					for (; i = o[r++];) "+" === i[0] ? (i = i.slice(1) || "*", (e[i] = e[i] || []).unshift(n)) : (e[i] = e[i] || [])
						.push(n)
			}
		}
		...
		function V(e, t, n, i) {
			...
			for (o = c.shift(); o;)
				if (e.responseFields[o] && (n[e.responseFields[o]] = t), !l && i && e.dataFilter && (t = e.dataFilter(t, e.dataType)),
					l = o, o = c.shift())
					if ("*" === o) o = l;
					else if ("*" !== l && l !== o) {
				if (!(s = u[l + " " + o] || u["* " + o]))
		...
		re.fn = re.prototype = {
			...
			var e, t, n, i, r, o, s = arguments[0] || {},
				...
				l = arguments.length,
				u = !1;
			for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || re.isFunction(s) || (s = {}),
				a === l && (s = this, a--); l > a; a++)
				if (null != (e = arguments[a]))
					for (t in e) n = s[t], i = e[t], s !== i && (u && i && (re.isPlainObject(i) || (r = re.isArray(i))) ? (r ? (r = !
							1, o = n && re.isArray(n) ? n : []) : o = n && re.isPlainObject(n) ? n : {}, s[t] = re.extend(u, o, i)) :
						void 0 !== i && (s[t] = i));
			return s
		}, re.extend({
			...
			type: function(e) {
				return null == e ? e + "" : "object" == typeof e || "function" == typeof e ? ee[te.call(e)] || "object" :
					typeof e
			},
			globalEval: function(e) {
				var t, n = eval;
				(e = re.trim(e)) && (1 === e.indexOf("use strict") ? (t = K.createElement("script"), t.text = e, K.head.appendChild(
			...
			proxy: function(e, t) {
				var n, i, r;
				return "string" == typeof t && (n = e[t], t = e, e = n), re.isFunction(e) ? (i = X.call(arguments, 2), r =
					function() {
			...
			now: Date.now,
			support: ie
		}), "function" == typeof Symbol && (re.fn[Symbol.iterator] = Q[Symbol.iterator]), re.each(
		...
		var ue = function(e) {
				...
				if (!i && ((t ? t.ownerDocument || t : H) !== O && I(t), t = t || O, N)) {
					if (11 !== g && (f = ge.exec(e)))
						if (r = f[1]) {
							...
							if ((r = f[3]) && b.getElementsByClassName && t.getElementsByClassName) return X.apply(n, t.getElementsByClassName(
								r)), n
						} if (b.qsa && !B[e + " "] && (!j || !j.test(e))) {
						if (1 !== g) p = t, h = e;
						else if ("object" !== t.nodeName.toLowerCase()) {
							for ((a = t.getAttribute("id")) ? a = a.replace(me, "\\$&") : t.setAttribute("id", a = R), d = x(e), o = d.length,
								u = ce.test(a) ? "#" + a : "[id='" + a + "']"; o--;) d[o] = u + " " + c(d[o]);
			...
			function f(e, t, n) {
				...
				return t.first ? function(t, n, o) {
					...
					if (s) {
						...
						for (; t = t[i];)
							if (1 === t.nodeType || r) {
								if (u = t[R] || (t[R] = {}), l = u[t.uniqueID] || (u[t.uniqueID] = {}), (a = l[i]) && a[0] === F && a[1] ===
									o) return c[2] = a[2];
			...
			function v(e) {
				for (var t, n, i, r = e.length, o = _.relative[e[0].type], s = o || _.relative[" "], a = o ? 1 : 0, l = f(
						function(e) {
							return e === t
						}, s, !0), u = f(function(e) {
						return J(t, e) > -1
			...
			var y, b, _, w, E, x, C, T, A, k, S, I, O, D, N, j, L, P, M, R = "sizzle" + 1 * new Date,
				...
				be = function(e, t, n) {
					var i = "0x" + t - 65536;
					return i !== i || n ? t : 0 > i ? String.fromCharCode(i + 65536) : String.fromCharCode(i >> 10 | 55296, 1023 & i |
						56320)
				},
				_e = function() {
					I()
			...
			b = t.support = {}, E = t.isXML = function(e) {
				...
				return i !== O && 9 === i.nodeType && i.documentElement ? (O = i, D = O.documentElement, N = !E(O), (n = O.defaultView) &&
					n.top !== n && (n.addEventListener ? n.addEventListener("unload", _e, !1) : n.attachEvent && n.attachEvent(
						"onunload", _e)), b.attributes = r(function(e) {
						...
						D.appendChild(e).innerHTML = "<a id='" + R + "'></a><select id='" + R +
							"-\r\\' msallowcapture=''><option selected=''></option></select>", e.querySelectorAll(
								"[msallowcapture^='']").length && j.push("[*^$]=" + ee + "*(?:''|\"\")"), e.querySelectorAll("[selected]")
							.length || j.push("\\[" + ee + "*(?:value|" + Z + ")"), e.querySelectorAll("[id~=" + R + "-]").length || j
							.push("~="), e.querySelectorAll(":checked").length || j.push(":checked"), e.querySelectorAll("a#" + R +
								"+*").length || j.push(".#.+[+~]")
					}), r(function(e) {
						var t = O.createElement("input");
						t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]")
							.length && j.push("name" + ee + "*[*^$|!~]?="), e.querySelectorAll(":enabled").length || j.push(":enabled",
								":disabled"), e.querySelectorAll("*,:x"), j.push(",.*:")
					})), (b.matchesSelector = pe.test(P = D.matches || D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector ||
						D.msMatchesSelector)) && r(function(e) {
						b.disconnectedMatch = P.call(e, "div"), P.call(e, "[s!='']:x"), L.push("!=", ie)
					}), j = j.length && new RegExp(j.join("|")), L = L.length && new RegExp(L.join("|")), t = pe.test(D.compareDocumentPosition),
					M = t || pe.test(D.contains) ? function(e, t) {
						...
						return n || (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n ||
							!b.sortDetached && t.compareDocumentPosition(e) === n ? e === O || e.ownerDocument === H && M(H, e) ? -1 :
							t === O || t.ownerDocument === H && M(H, t) ? 1 : k ? J(k, e) - J(k, t) : 0 : 4 & n ? -1 : 1)
					} : function(e, t) {
						if (e === t) return S = !0, 0;
						var n, i = 0,
							r = e.parentNode,
				...
				if ((e.ownerDocument || e) !== O && I(e), n = n.replace(le, "='$1']"), b.matchesSelector && N && !B[n + " "] &&
				...
				return void 0 !== i ? i : b.attributes || !N ? e.getAttribute(t) : (i = e.getAttributeNode(t)) && i.specified ?
					i.value : null
			}, t.error = function(e) {
				...
				preFilter: {
					ATTR: function(e) {
						return e[1] = e[1].replace(ye, be), e[3] = (e[3] || e[4] || e[5] || "").replace(ye, be), "~=" === e[2] && (e[
							3] = " " + e[3] + " "), e.slice(0, 4)
					},
					CHILD: function(e) {
					...
					PSEUDO: function(e) {
						var t, n = !e[6] && e[2];
						return fe.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && ue.test(n) && (t = x(n, !0)) &&
				...
				filter: {
					...
					ATTR: function(e, n, i) {
						return function(r) {
							var o = t.attr(r, e);
							return null == o ? "!=" === n : !n || (o += "", "=" === n ? o === i : "!=" === n ? o !== i : "^=" === n ? i &&
								0 === o.indexOf(i) : "*=" === n ? i && o.indexOf(i) > -1 : "$=" === n ? i && o.slice(-i.length) === i :
								"~=" === n ? (" " + o.replace(re, " ") + " ").indexOf(i) > -1 : "|=" === n && (o === i || o.slice(0, i.length +
									1) === i + "-"))
						}
					},
						...
						return 1 === i && 0 === r ? function(e) {
							...
							if (v) {
								...
								if (p = [s ? v.firstChild : v.lastChild], s && y) {
									for (d = v, f = d[R] || (d[R] = {}), c = f[d.uniqueID] || (f[d.uniqueID] = {}), u = c[e] || [], h = u[0] ===
										F && u[1], b = h && u[2], d = h && v.childNodes[h]; d = ++h && d && d[g] || (b = h = 0) || p.pop();)
										...
										h = u[0] === F && u[1], b = h), !1 === b)
									for (;
										(d = ++h && d && d[g] || (b = h = 0) || p.pop()) && ((a ? d.nodeName.toLowerCase() !== m : 1 !== d.nodeType) ||
											!++b || (y && (f = d[R] || (d[R] = {}), c = f[d.uniqueID] || (f[d.uniqueID] = {}), c[e] = [F, b]), d !==
												t)););
			...
			return u.prototype = _.filters = _.pseudos, _.setFilters = new u, x = t.tokenize = function(e, n) {
				...
				for (a = e, l = [], u = _.preFilter; a;) {
					i && !(r = se.exec(a)) || (r && (a = a.slice(r[0].length) || a), l.push(o = [])), i = !1, (r = ae.exec(a)) && (
						i = r.shift(), o.push({
							value: i,
							type: r[0].replace(oe, " ")
						}), a = a.slice(i.length));
				...
				if (n = n || [], 1 === d.length) {
					if (o = d[0] = d[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && b.getById && 9 === t.nodeType && N &&
						_.relative[o[1].type]) {
			...
			}, b.sortStable = R.split("").sort(U).join("") === R, b.detectDuplicates = !!S, I(), b.sortDetached = r(function(
				e) {
		...
		re.find = ue, re.expr = ue.selectors, re.expr[":"] = re.expr.pseudos, re.uniqueSort = re.unique = ue.uniqueSort, re.text =
			ue.getText, re.isXMLDoc = ue.isXML, re.contains = ue.contains;
		...
		re.filter = function(e, t, n) {
			var i = t[0];
			return n && (e = ":not(" + e + ")"), 1 === t.length && 1 === i.nodeType ? re.find.matchesSelector(i, e) ? [i] : [] :
				re.find.matches(e, re.grep(t, function(e) {
					return 1 === e.nodeType
				}))
		}, re.fn.extend({
			find: function(e) {
				...
				return i = this.pushStack(n > 1 ? re.unique(i) : i), i.selector = this.selector ? this.selector + " " + e : e,
					i
			},
			filter: function(e) {
		...
		(re.fn.init = function(e, t, n) {
			...
			if (n = n || ge, "string" == typeof e) {
				...
				if (i[1]) {
					if (t = t instanceof re ? t[0] : t, re.merge(this, re.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : K,
							!0)), he.test(i[1]) && re.isPlainObject(t))
						for (i in t) re.isFunction(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
					return this
				}
				return r = K.getElementById(i[2]), r && r.parentNode && (this.length = 1, this[0] = r), this.context = K, this.selector =
					e, this
			}
			return e.nodeType ? (this.context = this[0] = e, this.length = 1, this) : re.isFunction(e) ? void 0 !== n.ready ?
				n.ready(e) : e(re) : (void 0 !== e.selector && (this.selector = e.selector, this.context = e.context), re.makeArray(
					e, this))
		...
		re.fn.extend({
			...
			closest: function(e, t) {
				for (var n, i = 0, r = this.length, o = [], s = de.test(e) || "string" != typeof e ? re(e, t || this.context) :
						0; r > i; i++)
			...
			index: function(e) {
				return e ? "string" == typeof e ? Z.call(re(e), this[0]) : Z.call(this, e.jquery ? e[0] : e) : this[0] && this[
			...
			re.fn[e] = function(n, i) {
				...
				return "Until" !== e.slice(-5) && (i = n), i && "string" == typeof i && (r = re.filter(i, r)), this.length > 1 &&
					(ye[e] || re.uniqueSort(r), me.test(e) && r.reverse()), this.pushStack(r)
			}
		});
		var be = /\S+/g;
		re.Callbacks = function(e) {
							...
							return re.Deferred(function(n) {
								re.each(t, function(t, o) {
									...
									r[o[1]](function() {
										...
										e && re.isFunction(e.promise) ? e.promise().progress(n.notify).done(n.resolve).fail(n.reject) : n[
											o[0] + "With"](this === i ? n.promise() : this, s ? [e] : arguments)
									})
								}), e = null
							}).promise()
						},
			...
			when: function(e) {
				var t, n, i, r = 0,
					...
					u = function(e, n, i) {
						return function(r) {
							n[e] = this, i[e] = arguments.length > 1 ? X.call(arguments) : r, i === t ? l.notifyWith(n, i) : --a || l.resolveWith(
								n, i)
						}
					};
				if (s > 1)
					for (t = new Array(s), n = new Array(s), i = new Array(s); s > r; r++) o[r] && re.isFunction(o[r].promise) ? o[
						r].promise().progress(u(r, n, t)).done(u(r, i, o)).fail(l.reject) : --a;
		...
		re.fn.ready = function(e) {
			...
			ready: function(e) {
				(!0 === e ? --re.readyWait : re.isReady) || (re.isReady = !0, !0 !== e && --re.readyWait > 0 || (_e.resolveWith(
					K, [re]), re.fn.triggerHandler && (re(K).triggerHandler("ready"), re(K).off("ready"))))
			}
		}), re.ready.promise = function(t) {
			return _e || (_e = re.Deferred(), "complete" === K.readyState || "loading" !== K.readyState && !K.documentElement.doScroll ?
				e.setTimeout(re.ready) : (K.addEventListener("DOMContentLoaded", s), e.addEventListener("load", s))), _e.promise(
				t)
		}, re.ready.promise();
		var we = function(e, t, n, i, r, o, s) {
				...
				} else if (void 0 !== i && (r = !0, re.isFunction(i) || (s = !0), u && (s ? (t.call(e, i), t = null) : (u = t, t =
						function(e, t, n) {
		...
		a.uid = 1, a.prototype = {
			...
			access: function(e, t, n) {
				var i;
				return void 0 === t || t && "string" == typeof t && void 0 === n ? (i = this.get(e, t), void 0 !== i ? i : this.get(
					e, re.camelCase(t))) : (this.set(e, t, n), void 0 !== n ? n : t)
			},
			remove: function(e, t) {
				...
				if (void 0 !== o) {
					if (void 0 === t) this.register(e);
						...
						re.isArray(t) ? i = t.concat(t.map(re.camelCase)) : (r = re.camelCase(t), t in o ? i = [t, r] : (i = r, i = i in
							o ? [i] : i.match(be) || [])), n = i.length;
						for (; n--;) delete o[i[n]]
		...
		re.extend({
			...
			data: function(e, t) {
				...
				if (void 0 === e) {
					if (this.length && (r = Ce.get(o), 1 === o.nodeType && !xe.get(o, "hasDataAttrs"))) {
						for (n = s.length; n--;) s[n] && (i = s[n].name, 0 === i.indexOf("data-") && (i = re.camelCase(i.slice(5)), l(
							o, i, r[i])));
			...
			queue: function(e, t, n) {
				var i;
				return e ? (t = (t || "fx") + "queue", i = xe.get(e, t), n && (!i || re.isArray(n) ? i = xe.access(e, t, re.makeArray(
					n)) : i.push(n)), i || []) : void 0
			},
			dequeue: function(e, t) {
				...
				"inprogress" === r && (r = n.shift(), i--), r && ("fx" === t && n.unshift("inprogress"), delete o.stop, r.call(
					e, s, o)), !i && o && o.empty.fire()
			},
			...
			queue: function(e, t) {
				var n = 2;
				return "string" != typeof e && (t = e, e = "fx", n--), arguments.length < n ? re.queue(this[0], e) : void 0 ===
			...
			promise: function(e, t) {
				...
				for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; s--;)(n = xe.get(o[s], e + "queueHooks")) && n
					.empty && (i++, n.empty.add(a));
		...
		! function() {
			...
			n.setAttribute("type", "radio"), n.setAttribute("checked", "checked"), n.setAttribute("name", "t"), t.appendChild(n),
				ie.checkClone = t.cloneNode(!0).cloneNode(!0).lastChild.checked, t.innerHTML = "<textarea>x</textarea>", ie.noCloneChecked = !
		...
		re.event = {
			...
			add: function(e, t, n, i, r) {
				...
				if (v)
					for (n.handler && (o = n, n = o.handler, r = o.selector), n.guid || (n.guid = re.guid++), (l = v.events) || (l =
							v.events = {}), (s = v.handle) || (s = v.handle = function(t) {
							return void 0 !== re && re.event.triggered !== t.type ? re.event.dispatch.apply(e, arguments) : void 0
						}), t = (t || "").match(be) || [""], u = t.length; u--;) a = He.exec(t[u]) || [], h = g = a[1], p = (a[2] ||
						"").split(".").sort(), h && (f = re.event.special[h] || {}, h = (r ? f.delegateType : f.bindType) || h, f =
						re.event.special[h] || {}, c = re.extend({
							type: h,
							origType: g,
							data: i,
							handler: n,
							...
							namespace: p.join(".")
						}, o), (d = l[h]) || (d = l[h] = [], d.delegateCount = 0, f.setup && !1 !== f.setup.call(e, i, p, s) || e.addEventListener &&
							e.addEventListener(h, s)), f.add && (f.add.call(e, c), c.handler.guid || (c.handler.guid = n.guid)), r ? d.splice(
							d.delegateCount++, 0, c) : d.push(c), re.event.global[h] = !0)
			},
				...
				if (v && (l = v.events)) {
					for (t = (t || "").match(be) || [""], u = t.length; u--;)
						if (a = He.exec(t[u]) || [], h = g = a[1], p = (a[2] || "").split(".").sort(), h) {
							for (f = re.event.special[h] || {}, h = (i ? f.delegateType : f.bindType) || h, d = l[h] || [], a = a[2] &&
								new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = d.length; o--;) c = d[o], !r && g !==
								c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i ||
									!c.selector) || (d.splice(o, 1), c.selector && d.delegateCount--, f.remove && f.remove.call(e, c));
				...
				if (a[0] = e, e.delegateTarget = this, !u.preDispatch || !1 !== u.preDispatch.call(this, e)) {
					for (s = re.event.handlers.call(this, e, l), t = 0;
						...
						for (e.currentTarget = r.elem, n = 0;
							(o = r.handlers[n++]) && !e.isImmediatePropagationStopped();) e.rnamespace && !e.rnamespace.test(o.namespace) ||
							(e.handleObj = o, e.data = o.data, void 0 !== (i = ((re.event.special[o.origType] || {}).handle || o.handler)
								.apply(r.elem, a)) && !1 === (e.result = i) && (e.preventDefault(), e.stopPropagation()));
				...
				if (a && l.nodeType && ("click" !== e.type || isNaN(e.button) || e.button < 1))
					for (; l !== this; l = l.parentNode || this)
						if (1 === l.nodeType && (!0 !== l.disabled || "click" !== e.type)) {
							for (i = [], n = 0; a > n; n++) o = t[n], r = o.selector + " ", void 0 === i[r] && (i[r] = o.needsContext ?
								re(r, this).index(l) > -1 : re.find(r, this, null, [l]).length), i[r] && i.push(o);
							i.length && s.push({
								elem: l,
								handlers: i
							})
			...
			mouseHooks: {
				...
				filter: function(e, t) {
					...
					return null == e.pageX && null != t.clientX && (n = e.target.ownerDocument || K, i = n.documentElement, r = n.body,
						e.pageX = t.clientX + (i && i.scrollLeft || r && r.scrollLeft || 0) - (i && i.clientLeft || r && r.clientLeft ||
							0), e.pageY = t.clientY + (i && i.scrollTop || r && r.scrollTop || 0) - (i && i.clientTop || r && r.clientTop ||
			...
			fix: function(e) {
				...
				var t, n, i, r = e.type,
					o = e,
					s = this.fixHooks[r];
				for (s || (this.fixHooks[r] = s = Re.test(r) ? this.mouseHooks : Me.test(r) ? this.keyHooks : {}), i = s.props ?
					this.props.concat(s.props) : this.props, e = new re.Event(o), t = i.length; t--;) n = i[t], e[n] = o[n];
			...
			return this instanceof re.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented =
				e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? h : p) : this.type = e, t && re.extend(
				this, t), this.timeStamp = e && e.timeStamp || re.now(), void(this[re.expando] = !0)) : new re.Event(e, t)
		}, re.Event.prototype = {
			...
			re.event.special[e] = {
				...
				handle: function(e) {
					var n, i = this,
						r = e.relatedTarget,
						o = e.handleObj;
					return r && (r === i || re.contains(i, r)) || (e.type = o.origType, n = o.handler.apply(this, arguments), e.type =
						t), n
				}
			}
		}), re.fn.extend({
			...
			off: function(e, t, n) {
				var i, r;
				if (e && e.preventDefault && e.handleObj) return i = e.handleObj, re(e.delegateTarget).off(i.namespace ? i.origType +
		...
		re.extend({
			...
			re.fn[e] = function(e) {
				for (var n, i = [], r = re(e), o = r.length - 1, s = 0; o >= s; s++) n = s === o ? this : this.clone(!0), re(r[
					s])[t](n), J.apply(i, n.get());
		...
		! function() {
			function t() {
				a.style.cssText =
					...
					a.innerHTML = "", Xe.appendChild(s);
				var t = e.getComputedStyle(a);
				n = "1%" !== t.top, o = "2px" === t.marginLeft, i = "4px" === t.width, a.style.marginRight = "50%", r = "4px" ===
					t.marginRight, Xe.removeChild(s)
			}
			var n, i, r, o, s = K.createElement("div"),
				a = K.createElement("div");
			a.style && (a.style.backgroundClip = "content-box", a.cloneNode(!0).style.backgroundClip = "", ie.clearCloneStyle =
				"content-box" === a.style.backgroundClip, s.style.cssText =
				"border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", s.appendChild(a), re
				.extend(ie, {
					...
					reliableMarginRight: function() {
						...
						return n.style.cssText = a.style.cssText =
							...
							n.style.width = "0", a.style.width = "1px", Xe.appendChild(s), t = !parseFloat(e.getComputedStyle(n).marginRight),
							Xe.removeChild(s), a.removeChild(n), t
					}
				}))
		}();
		...
		re.extend({
			...
			style: function(e, t, n, i) {
				if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
					var r, o, s, a = re.camelCase(t),
						l = e.style;
					return t = re.cssProps[a] || (re.cssProps[a] = S(a) || a), s = re.cssHooks[t] || re.cssHooks[a], void 0 === n ?
						s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : l[t] : (o = typeof n, "string" === o && (r = Se.exec(
							n)) && r[1] && (n = u(e, t, r), o = "number"), void(null != n && n === n && ("number" === o && (n += r && r[
								3] || (re.cssNumber[a] ? "" : "px")), ie.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") ||
							(l[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l[t] = n))))
				}
			},
			css: function(e, t, n, i) {
				var r, o, s, a = re.camelCase(t);
				return t = re.cssProps[a] || (re.cssProps[a] = S(a) || a), s = re.cssHooks[t] || re.cssHooks[a], s && "get" in
					s && (r = s.get(e, !0, n)), void 0 === r && (r = A(e, t, i)), "normal" === r && t in Ze && (r = Ze[t]), "" ===
			...
			re.cssHooks[e + t] = {
				expand: function(n) {
					for (var i = 0, r = {}, o = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++) r[e + Ie[i] + t] = o[i] ||
						o[i - 2] || o[0];
					return r
				}
			...
			init: function(e, t, n, i, r, o) {
				this.elem = e, this.prop = n, this.easing = r || re.easing._default, this.options = t, this.start = this.now =
					this.cur(), this.end = i, this.unit = o || (re.cssNumber[n] ? "" : "px")
			},
			cur: function() {
			...
			run: function(e) {
				...
				return this.options.duration ? this.pos = t = re.easing[this.easing](e, this.options.duration * e, 0, 1, this.options
						.duration) : this.pos = t = e, this.now = (this.end - this.start) * t + this.start, this.options.step && this.options
					.step.call(this.elem, this.now, this), n && n.set ? n.set(this) : j.propHooks._default.set(this), this
			}
			...
			_default: {
				get: function(e) {
					...
					return 1 !== e.elem.nodeType || null != e.elem[e.prop] && null == e.elem.style[e.prop] ? e.elem[e.prop] : (t =
						re.css(e.elem, e.prop, ""), t && "auto" !== t ? t : 0)
				},
				set: function(e) {
					re.fx.step[e.prop] ? re.fx.step[e.prop](e) : 1 !== e.elem.nodeType || null == e.elem.style[re.cssProps[e.prop]] &&
						!re.cssHooks[e.prop] ? e.elem[e.prop] = e.now : re.style(e.elem, e.prop, e.now + e.unit)
				}
			}
		...
		re.Animation = re.extend(F, {
				...
				tweener: function(e, t) {
					...
					for (var n, i = 0, r = e.length; r > i; i++) n = e[i], F.tweeners[n] = F.tweeners[n] || [], F.tweeners[n].unshift(
						t)
				},
				prefilters: [R],
				...
				return i.duration = re.fx.off ? 0 : "number" == typeof i.duration ? i.duration : i.duration in re.fx.speeds ? re.fx
					.speeds[i.duration] : re.fx.speeds._default, null != i.queue && !0 !== i.queue || (i.queue = "fx"), i.old = i.complete,
					i.complete = function() {
				...
				stop: function(e, t, n) {
					...
					return "string" != typeof e && (n = t, t = e, e = void 0), t && !1 !== e && this.queue(e || "fx", []), this.each(
						function() {
							...
							for (r = o.length; r--;) o[r].elem !== this || null != e && o[r].queue !== e || (o[r].anim.stop(n), t = !1,
								o.splice(r, 1));
				...
				finish: function(e) {
					return !1 !== e && (e = e || "fx"), this.each(function() {
						var t, n = xe.get(this),
							...
							o = re.timers,
							s = i ? i.length : 0;
						for (n.finish = !0, re.queue(this, e, []), r && r.stop && r.stop.call(this, !0), t = o.length; t--;) o[t].elem ===
			...
			function() {
				...
				e.type = "checkbox", ie.checkOn = "" !== e.value, ie.optSelected = n.selected, t.disabled = !0, ie.optDisabled = !
					n.disabled, e = K.createElement("input"), e.value = "t", e.type = "radio", ie.radioValue = "t" === e.value
			}();
		...
		re.fn.extend({
			...
			attr: function(e, t, n) {
				...
				if (3 !== o && 8 !== o && 2 !== o) return void 0 === e.getAttribute ? re.prop(e, t, n) : (1 === o && re.isXMLDoc(
						e) || (t = t.toLowerCase(), r = re.attrHooks[t] || (re.expr.match.bool.test(t) ? st : void 0)), void 0 !==
					n ? null === n ? void re.removeAttr(e, t) : r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : (e.setAttribute(
						t, n + ""), n) : r && "get" in r && null !== (i = r.get(e, t)) ? i : (i = re.find.attr(e, t), null == i ?
						void 0 : i))
			},
			attrHooks: {
				type: {
		...
		re.fn.extend({
			...
			prop: function(e, t, n) {
				var i, r, o = e.nodeType;
				if (3 !== o && 8 !== o && 2 !== o) return 1 === o && re.isXMLDoc(e) || (t = re.propFix[t] || t, r = re.propHooks[
						t]), void 0 !== n ? r && "set" in r && void 0 !== (i = r.set(e, n, t)) ? i : e[t] = n : r && "get" in r &&
		...
		}), re.each(["tabIndex", "readOnly", "maxLength", "cellSpacing", "cellPadding", "rowSpan", "colSpan", "useMap",
		...
		re.fn.extend({
			...
			toggleClass: function(e, t) {
				var n = typeof e;
				return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : re.isFunction(e) ?
					this.each(function(n) {
						re(this).toggleClass(e.call(this, n, $(this), t), t)
					}) : this.each(function() {
						var t, i, r, o;
						if ("string" === n)
							for (i = 0, r = re(this), o = e.match(be) || []; t = o[i++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(
								t);
						else void 0 !== e && "boolean" !== n || (t = $(this), t && xe.set(this, "__className__", t), this.setAttribute &&
							this.setAttribute("class", t || !1 === e ? "" : xe.get(this, "__className__") || ""))
					})
			},
			hasClass: function(e) {
				var t, n, i = 0;
		...
		re.fn.extend({
			val: function(e) {
				...
				return arguments.length ? (i = re.isFunction(e), this.each(function(n) {
					var r;
					1 === this.nodeType && (r = i ? e.call(this, n, re(this).val()) : e, null == r ? r = "" : "number" ==
						typeof r ? r += "" : re.isArray(r) && (r = re.map(r, function(e) {
							return null == e ? "" : e + ""
						})), (t = re.valHooks[this.type] || re.valHooks[this.nodeName.toLowerCase()]) && "set" in t && void 0 !==
						t.set(this, r, "value") || (this.value = r))
				})) : r ? (t = re.valHooks[r.type] || re.valHooks[r.nodeName.toLowerCase()], t && "get" in t && void 0 !== (n =
					t.get(r, "value")) ? n : (n = r.value, "string" == typeof n ? n.replace(ft, "") : null == n ? "" : n)) : void 0
			}
		}), re.extend({
			valHooks: {
				option: {
				...
				select: {
					get: function(e) {
						for (var t, n, i = e.options, r = e.selectedIndex, o = "select-one" === e.type || 0 > r, s = o ? null : [], a =
								o ? r + 1 : i.length, l = 0 > r ? a : o ? r : 0; a > l; l++)
							if (n = i[l], (n.selected || l === r) && (ie.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) &&
								(!n.parentNode.disabled || !re.nodeName(n.parentNode, "optgroup"))) {
								if (t = re(n).val(), o) return t;
								s.push(t)
							} return s
					},
					set: function(e, t) {
						for (var n, i, r = e.options, o = re.makeArray(t), s = r.length; s--;) i = r[s], (i.selected = re.inArray(re.valHooks
		...
		re.extend(re.event, {
			trigger: function(t, n, i, r) {
				...
				if (s = a = i = i || K, 3 !== i.nodeType && 8 !== i.nodeType && !ht.test(h + re.event.triggered) && (h.indexOf(
							".") > -1 && (p = h.split("."), h = p.shift(), p.sort()), u = h.indexOf(":") < 0 && "on" + h, t = t[re.expando] ?
						t : new re.Event(h, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = p.join("."), t.rnamespace =
						t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target ||
						(t.target = i), n = null == n ? [t] : re.makeArray(n, [t]), f = re.event.special[h] || {}, r || !f.trigger ||
						!1 !== f.trigger.apply(i, n))) {
					...
					for (o = 0;
						(s = d[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? l : f.bindType || h, c = (xe.get(s, "events") ||
						{})[t.type] && xe.get(s, "handle"), c && c.apply(s, n), (c = u && s[u]) && c.apply && Ee(s) && (t.result = c
						.apply(s, n), !1 === t.result && t.preventDefault());
					return t.type = h, r || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(d.pop(), n) || !Ee(i) ||
						u && re.isFunction(i[h]) && !re.isWindow(i) && (a = i[u], a && (i[u] = null), re.event.triggered = h, i[h](),
							re.event.triggered = void 0, a && (i[u] = a)), t.result
				}
			},
		...
		At.href = pt.href, re.extend({
			...
			ajax: function(t, n) {
				function i(t, n, i, a) {
					var u, f, y, b, w, x = n;
					2 !== _ && (_ = 2, l && e.clearTimeout(l), r = void 0, s = a || "", E.readyState = t > 0 ? 4 : 0, u = t >= 200 &&
						300 > t || 304 === t, i && (b = U(d, E, i)), b = V(d, b, E, u), u ? (d.ifModified && (w = E.getResponseHeader(
								"Last-Modified"), w && (re.lastModified[o] = w), (w = E.getResponseHeader("etag")) && (re.etag[o] = w)),
							204 === t || "HEAD" === d.type ? x = "nocontent" : 304 === t ? x = "notmodified" : (x = b.state, f = b.data,
								y = b.error, u = !y)) : (y = x, !t && x || (x = "error", 0 > t && (t = 0))), E.status = t, E.statusText =
						(n || x) + "", u ? g.resolveWith(h, [f, x, E]) : g.rejectWith(h, [E, x, y]), E.statusCode(m), m = void 0, c &&
						p.trigger(u ? "ajaxSuccess" : "ajaxError", [E, d, u ? f : y]), v.fireWith(h, [E, x]), c && (p.trigger(
							"ajaxComplete", [E, d]), --re.active || re.event.trigger("ajaxStop")))
				}
				...
				if (g.promise(E).complete = v.add, E.success = E.done, E.error = E.fail, d.url = ((t || d.url || pt.href) + "")
					.replace(mt, "").replace(Et, pt.protocol + "//"), d.type = n.method || n.type || d.method || d.type, d.dataTypes =
					re.trim(d.dataType || "*").toLowerCase().match(be) || [""], null == d.crossDomain) {
					u = K.createElement("a");
					try {
				...
				if (d.data && d.processData && "string" != typeof d.data && (d.data = re.param(d.data, d.traditional)), q(xt, d,
						n, E), 2 === _) return E;
				c = re.event && d.global, c && 0 == re.active++ && re.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(),
					d.hasContent = !wt.test(d.type), o = d.url, d.hasContent || (d.data && (o = d.url += (vt.test(o) ? "&" : "?") +
						d.data, delete d.data), !1 === d.cache && (d.url = yt.test(o) ? o.replace(yt, "$1_=" + gt++) : o + (vt.test(
						o) ? "&" : "?") + "_=" + gt++)), d.ifModified && (re.lastModified[o] && E.setRequestHeader(
						"If-Modified-Since", re.lastModified[o]), re.etag[o] && E.setRequestHeader("If-None-Match", re.etag[o])), (d.data &&
						d.hasContent && !1 !== d.contentType || n.contentType) && E.setRequestHeader("Content-Type", d.contentType),
					E.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !==
						d.dataTypes[0] ? ", " + Tt + "; q=0.01" : "") : d.accepts["*"]);
			...
			wrapAll: function(e) {
				...
				}) : (this[0] && (t = re(e, this[0].ownerDocument).eq(0).clone(!0), this[0].parentNode && t.insertBefore(this[
					0]), t.map(function() {
		...
		re.param = function(e, t) {
			var n, i = [],
				r = function(e, t) {
					t = re.isFunction(t) ? t() : null == t ? "" : t, i[i.length] = encodeURIComponent(e) + "=" + encodeURIComponent(
						t)
				};
			if (void 0 === t && (t = re.ajaxSettings && re.ajaxSettings.traditional), re.isArray(e) || e.jquery && !re.isPlainObject(
					e)) re.each(e, function() {
			...
			serializeArray: function() {
				return this.map(function() {
					...
					var e = this.type;
					return this.name && !re(this).is(":disabled") && Dt.test(this.nodeName) && !Ot.test(e) && (this.checked || !
						De.test(e))
				}).map(function(e, t) {
					var n = re(this).val();
		...
		ie.cors = !!jt && "withCredentials" in jt, ie.ajax = jt = !!jt, re.ajaxTransport(function(t) {
			...
			return ie.cors || jt && !t.crossDomain ? {
				send: function(r, o) {
					...
					n = function(e) {
							return function() {
								n && (n = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === e ? a.abort() :
									"error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Nt[a.status] ||
		...
		re.ajaxSetup({
			...
			var r, o, s, a = !1 !== t.jsonp && (Pt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType ||
				"").indexOf("application/x-www-form-urlencoded") && Pt.test(t.data) && "data");
			return a || "jsonp" === t.dataTypes[0] ? (r = t.jsonpCallback = re.isFunction(t.jsonpCallback) ? t.jsonpCallback() :
				t.jsonpCallback, a ? t[a] = t[a].replace(Pt, "$1" + r) : !1 !== t.jsonp && (t.url += (vt.test(t.url) ? "&" :
					"?") + t.jsonp + "=" + r), t.converters["script json"] = function() {
					return s || re.error(r + " was not called"), s[0]
				}, t.dataTypes[0] = "json", o = e[r], e[r] = function() {
					s = arguments
				}, i.always(function() {
					void 0 === o ? re(e).removeProp(r) : e[r] = o, t[r] && (t.jsonpCallback = n.jsonpCallback, Lt.push(r)), s &&
						re.isFunction(o) && o(s[0]), s = o = void 0
				}), "script") : void 0
		...
		re.fn.load = function(e, t, n) {
			...
			var i, r, o, s = this,
				a = e.indexOf(" ");
			return a > -1 && (i = re.trim(e.slice(a)), e = e.slice(0, a)), re.isFunction(t) ? (n = t, t = void 0) : t &&
				"object" == typeof t && (r = "POST"), s.length > 0 && re.ajax({
					url: e,
					type: r || "GET",
					dataType: "html",
					data: t
			...
			setOffset: function(e, t, n) {
				var i, r, o, s, a, l, u, c = re.css(e, "position"),
					f = re(e),
					d = {};
				"static" === c && (e.style.position = "relative"), a = f.offset(), o = re.css(e, "top"), l = re.css(e, "left"),
					u = ("absolute" === c || "fixed" === c) && (o + l).indexOf("auto") > -1, u ? (i = f.position(), s = i.top, r =
						i.left) : (s = parseFloat(o) || 0, r = parseFloat(l) || 0), re.isFunction(t) && (t = t.call(e, n, re.extend({},
						a))), null != t.top && (d.top = t.top - a.top + s), null != t.left && (d.left = t.left - a.left + r), "using" in
			...
			position: function() {
				if (this[0]) {
					...
					return "fixed" === re.css(n, "position") ? t = n.getBoundingClientRect() : (e = this.offsetParent(), t = this.offset(),
						re.nodeName(e[0], "html") || (i = e.offset()), i.top += re.css(e[0], "borderTopWidth", !0), i.left += re.css(
			...
			re.fn[e] = function(i) {
				return we(this, function(e, i, r) {
					var o = G(e);
					return void 0 === r ? o ? o[t] : e[i] : void(o ? o.scrollTo(n ? o.pageXOffset : r, n ? r : o.pageYOffset) :
						e[i] = r)
			...
			re.each({
				...
				re.fn[i] = function(i, r) {
					...
					return we(this, function(t, n, i) {
						...
						) : void 0 === i ? re.css(t, n, s) : re.style(t, n, i, s)
					}, t, o ? i : void 0, o, null)
				}
			})
		}), re.fn.extend({
		...
		"function" == typeof define && define.amd ? define(t) : "object" == typeof exports ? module.exports = t(require,
			exports, module) : e.Tether = t()
	}(this, function(e, t, n) {
		"use strict";
		...
		function o(e) {
			...
			for (var r = e;
				...
				var s = o,
					a = s.overflow,
					l = s.overflowX;
				/(auto|scroll)/.test(a + s.overflowY + l) && ("absolute" !== n || ["relative", "absolute", "fixed"].indexOf(o.position) >=
					0) && i.push(r)
			}
		...
		function a(e) {
			...
			var n = t.documentElement,
				i = r(e),
				o = S();
			return i.top -= o.top, i.left -= o.left, void 0 === i.width && (i.width = document.body.scrollWidth - i.left - i.right),
				void 0 === i.height && (i.height = document.body.scrollHeight - i.top - i.bottom), i.top = i.top - n.clientTop, i.left =
				i.left - n.clientLeft, i.right = t.body.clientWidth - i.width - i.left, i.bottom = t.body.clientHeight - i.height -
				i.top, i
		}
		...
		function _() {
			...
			return n.forEach(function(t) {
				var n = t.top,
					i = t.left;
				"string" == typeof n && (n = parseFloat(n, 10)), "string" == typeof i && (i = parseFloat(i, 10)), e.top += n, e.left +=
					i
			}), e
		}
		...
		function w(e, t) {
			return "string" == typeof e.left && -1 !== e.left.indexOf("%") && (e.left = parseFloat(e.left, 10) / 100 * t.width),
				"string" == typeof e.top && -1 !== e.top.indexOf("%") && (e.top = parseFloat(e.top, 10) / 100 * t.height), e
		}

		function E(e, t) {
			return "scrollParent" === t ? t = e.scrollParents[0] : "window" === t && (t = [pageXOffset, pageYOffset, innerWidth +
				pageXOffset, innerHeight + pageYOffset
				...
				K.forEach(function(e, n) {
					e = e[0].toUpperCase() + e.substr(1), "Top" === e || "Left" === e ? t[n] += parseFloat(r["border" + e +
						"Width"]) : t[n] -= parseFloat(r["border" + e + "Width"])
				})
			}(), t
		}
		var x = function() {
			...
			j = function() {
				...
				return x(e, [{
					...
					value: function(e, t, n) {
						...
						void 0 === this.bindings && (this.bindings = {}), void 0 === this.bindings[e] && (this.bindings[e] = []),
					...
					value: function(e, t) {
						if (void 0 !== this.bindings && void 0 !== this.bindings[e])
							if (void 0 === t) delete this.bindings[e];
								...
								for (var n = 0; n < this.bindings[e].length;) this.bindings[e][n].handler === t ? this.bindings[e].splice(
									n, 1) : ++n
					}
				}, {
					key: "trigger",
					value: function(e) {
						if (void 0 !== this.bindings && this.bindings[e]) {
							for (var t = 0, n = arguments.length, i = Array(n > 1 ? n - 1 : 0), r = 1; n > r; r++) i[r - 1] = arguments[
								r];
		...
		var L = function() {
				function e(e, t) {
					var n = [],
						...
						o = void 0;
					try {
						for (var s, a = e[Symbol.iterator](); !(i = (s = a.next()).done) && (n.push(s.value), !t || n.length !== t); i = !
							0);
					} catch (e) {
						r = !0, o = e
					} finally {
		...
		var M = C.Utils,
			...
			R = function() {
				...
				for (var e = document.createElement("div"), t = ["transform", "WebkitTransform", "OTransform", "MozTransform",
						"msTransform"
					], n = 0; n < t.length; ++n) {
					var i = t[n];
		...
		! function() {
			var e = null,
				...
				n = null,
				i = function i() {
					return void 0 !== t && t > 16 ? (t = Math.min(t - 16, 250), void(n = setTimeout(i, 250))) : void(void 0 !== e &&
						b() - e < 10 || (null != n && (clearTimeout(n), n = null), e = b(), F(), t = b() - e))
				};
			"undefined" != typeof window && void 0 !== window.addEventListener && ["resize", "scroll", "touchmove"].forEach(
				function(e) {
		...
		var $ = {
			...
			G = function(e) {
				function t(e) {
					var n = this;
					i(this, t), P(Object.getPrototypeOf(t.prototype), "constructor", this).call(this), this.position = this.position.bind(
						this), H.push(this), this.history = [], this.setOptions(e, !1), C.modules.forEach(function(e) {
				...
				return m(t, e), x(t, [{
					...
					value: function() {
						...
						return void 0 !== t && t[e] ? this.options.classes[e] : this.options.classPrefix ? this.options.classPrefix +
							"-" + e : e
					}
				}, {
					key: "setOptions",
					value: function(e) {
						...
						var r = this.options,
							...
							a = r.target,
							l = r.targetModifier;
						if (this.element = s, this.target = a, this.targetModifier = l, "viewport" === this.target ? (this.target =
								document.body, this.targetModifier = "visible") : "scroll-handle" === this.target && (this.target =
								document.body, this.targetModifier = "scroll-handle"), ["element", "target"].forEach(function(e) {
								if (void 0 === t[e]) throw new Error("Tether Error: Both element and target must be defined");
								void 0 !== t[e].jquery ? t[e] = t[e][0] : "string" == typeof t[e] && (t[e] = document.querySelector(t[e]))
							}), d(this.element, this.getClass("element")), !1 !== this.options.addTargetClasses && d(this.target, this.getClass(
								"target")), !this.options.attachment) throw new Error("Tether Error: You must provide an attachment");
						this.targetAttachment = z(this.options.targetAttachment), this.attachment = z(this.options.attachment), this
							.offset = V(this.options.offset), this.targetOffset = V(this.options.targetOffset), void 0 !== this.scrollParents &&
							this.disable(), "scroll-handle" === this.targetModifier ? this.scrollParents = [this.target] : this.scrollParents =
							o(this.target), !1 !== this.options.enabled && this.enable(n)
					}
				}, {
					key: "getTargetBounds",
					value: function() {
						...
						if ("visible" === this.targetModifier) {
							...
							return t.height = Math.min(t.height, e.height - (pageYOffset - e.top)), t.height = Math.min(t.height, e.height -
									(e.top + e.height - (pageYOffset + innerHeight))), t.height = Math.min(innerHeight, t.height), t.height -=
								2, t.width = Math.min(t.width, e.width - (pageXOffset - e.left)), t.width = Math.min(t.width, e.width - (e
									.left + e.width - (pageXOffset + innerWidth))), t.width = Math.min(innerWidth, t.width), t.width -= 2, t.top <
								pageYOffset && (t.top = pageYOffset), t.left < pageXOffset && (t.left = pageXOffset), t
						}
						if ("scroll-handle" === this.targetModifier) {
							...
							var i = getComputedStyle(n),
								r = n.scrollWidth > n.clientWidth || [i.overflow, i.overflowX].indexOf("scroll") >= 0 || this.target !==
								document.body,
								o = 0;
							r && (o = 15);
							var s = e.height - parseFloat(i.borderTopWidth) - parseFloat(i.borderBottomWidth) - o,
								...
								l = 0;
							408 > s && this.target === document.body && (l = -11e-5 * Math.pow(s, 2) - .00727 * s + 22.58), this.target !==
								document.body && (t.height = Math.max(t.height, 24));
							var u = this.target.scrollTop / (n.scrollHeight - s);
							return t.top = u * (s - t.height - l) + e.top + parseFloat(i.borderTopWidth), this.target === document.body &&
								(t.height = Math.max(t.height, 24)), t
						}
					}
				}, {
					key: "clearCache",
					...
					key: "cache",
					value: function(e, t) {
						return void 0 === this._cache && (this._cache = {}), void 0 === this._cache[e] && (this._cache[e] = t.call(
							this)), this._cache[e]
					}
				}, {
					key: "enable",
					value: function() {
						...
						!1 !== this.options.addTargetClasses && d(this.target, this.getClass("enabled")), d(this.element, this.getClass(
							"enabled")), this.enabled = !0, this.scrollParents.forEach(function(t) {
					...
					value: function() {
						var e = this;
						f(this.target, this.getClass("enabled")), f(this.element, this.getClass("enabled")), this.enabled = !1, void 0 !==
							this.scrollParents && this.scrollParents.forEach(function(t) {
					...
					value: function(e, t) {
						...
						void 0 !== this._addAttachClasses && this._addAttachClasses.length && this._addAttachClasses.splice(0, this._addAttachClasses
							.length), void 0 === this._addAttachClasses && (this._addAttachClasses = []);
						var r = this._addAttachClasses;
						e.top && r.push(this.getClass("element-attached") + "-" + e.top), e.left && r.push(this.getClass(
								"element-attached") + "-" + e.left), t.top && r.push(this.getClass("target-attached") + "-" + t.top), t.left &&
							r.push(this.getClass("target-attached") + "-" + t.left);
						var o = [];
						i.forEach(function(e) {
							o.push(n.getClass("element-attached") + "-" + e), o.push(n.getClass("target-attached") + "-" + e)
						}), D(function() {
							void 0 !== n._addAttachClasses && (v(n.element, n._addAttachClasses, o), !1 !== n.options.addTargetClasses &&
								v(n.target, n._addAttachClasses, o), delete n._addAttachClasses)
						})
					}
				}, {
					key: "position",
					value: function() {
						...
						if (this.enabled) {
							...
							var x = {
								...
								A = T.defaultView,
								k = void 0;
							return A.innerHeight > T.documentElement.clientHeight && (k = this.cache("scrollbar-size", u), x.viewport.bottom -=
									k.height), A.innerWidth > T.documentElement.clientWidth && (k = this.cache("scrollbar-size", u), x.viewport
									.right -= k.width), (-1 === ["", "static"].indexOf(T.body.style.position) || -1 === ["", "static"].indexOf(
									T.body.parentElement.style.position)) && (x.page.bottom = T.body.scrollHeight - m - o, x.page.right = T.body
									.scrollWidth - v - r), void 0 !== this.options.optimizations && !1 !== this.options.optimizations.moveElement &&
								void 0 === this.targetModifier && function() {
									...
									if (["Top", "Left", "Bottom", "Right"].forEach(function(e) {
										...
										}), n.right = T.body.scrollWidth - n.left - r.width + o.right, n.bottom = T.body.scrollHeight - n.top -
										r.height + o.bottom, x.page.top >= n.top + o.top && x.page.bottom >= n.bottom && x.page.left >= n.left +
										o.left && x.page.right >= n.right) {
										var s = t.scrollTop,
											u = t.scrollLeft;
										x.offset = {
							...
							var u = {
								...
								f = function(e, n) {
									if (!1 !== (void 0 !== t.options.optimizations ? t.options.optimizations.gpu : null)) {
										var i = void 0,
											r = void 0;
										e.top ? (u.top = 0, i = n.top) : (u.bottom = 0, i = -n.bottom), e.left ? (u.left = 0, r = n.left) : (u.right =
												0, r = -n.right), window.matchMedia && (window.matchMedia("only screen and (min-resolution: 1.3dppx)")
												.matches || window.matchMedia("only screen and (-webkit-min-device-pixel-ratio: 1.3)").matches || (r =
													Math.round(r), i = Math.round(i))), u[R] = "translateX(" + r + "px) translateY(" + i + "px)",
											"msTransform" !== R && (u[R] += " translateZ(0)")
									} else e.top ? u.top = n.top + "px" : u.bottom = n.bottom + "px", e.left ? u.left = n.left + "px" : u.right =
										n.right + "px"
								},
								d = !1;
							if ((n.page.top || n.page.bottom) && (n.page.left || n.page.right) ? (u.position = "absolute", f(n.page, e.page)) :
								(n.viewport.top || n.viewport.bottom) && (n.viewport.left || n.viewport.right) ? (u.position = "fixed", f(
									n.viewport, e.viewport)) : void 0 !== n.offset && n.offset.top && n.offset.left ? function() {
									u.position = "absolute";
		...
		C.modules.push({
			position: function(e) {
				...
				return this.options.constraints.forEach(function(e) {
					...
					var b = E(t, o);
					("target" === f || "both" === f) && (n < b[1] && "top" === m.top && (n += d, m.top = "bottom"), n + s > b[3] &&
						"bottom" === m.top && (n -= d, m.top = "top")), "together" === f && ("top" === m.top && ("bottom" === y.top &&
							n < b[1] ? (n += d, m.top = "bottom", n += s, y.top = "top") : "top" === y.top && n + s > b[3] && n - (s -
								d) >= b[1] && (n -= s - d, m.top = "bottom", y.top = "bottom")), "bottom" === m.top && ("top" === y.top &&
							n + s > b[3] ? (n -= d, m.top = "top", n -= s, y.top = "bottom") : "bottom" === y.top && n < b[1] && n +
							(2 * s - d) <= b[3] && (n += s - d, m.top = "top", y.top = "top")), "middle" === m.top && (n + s > b[3] &&
							"top" === y.top ? (n -= s, y.top = "bottom") : n < b[1] && "bottom" === y.top && (n += s, y.top = "top"))),
						("target" === c || "both" === c) && (i < b[0] && "left" === m.left && (i += h, m.left = "right"), i + l > b[
							2] && "right" === m.left && (i -= h, m.left = "left")), "together" === c && (i < b[0] && "left" === m.left ?
							"right" === y.left ? (i += h, m.left = "right", i += l, y.left = "left") : "left" === y.left && (i += h, m
								.left = "right", i -= l, y.left = "right") : i + l > b[2] && "right" === m.left ? "left" === y.left ? (i -=
								h, m.left = "left", i -= l, y.left = "right") : "right" === y.left && (i -= h, m.left = "left", i += l, y
								.left = "left") : "center" === m.left && (i + l > b[2] && "left" === y.left ? (i -= l, y.left = "right") :
								i < b[0] && "right" === y.left && (i += l, y.left = "left"))), ("element" === f || "both" === f) && (n <
							b[1] && "bottom" === y.top && (n += s, y.top = "top"), n + s > b[3] && "top" === y.top && (n -= s, y.top =
								"bottom")), ("element" === c || "both" === c) && (i < b[0] && ("right" === y.left ? (i += l, y.left =
							"left") : "center" === y.left && (i += l / 2, y.left = "left")), i + l > b[2] && ("left" === y.left ? (i -=
							l, y.left = "right") : "center" === y.left && (i -= l / 2, y.left = "right"))), "string" == typeof u ? u =
						u.split(",").map(function(e) {
							return e.trim()
						}) : !0 === u && (u = ["top", "left", "right", "bottom"]), u = u || [];
					var _ = [],
						w = [];
					n < b[1] && (u.indexOf("top") >= 0 ? (n = b[1], _.push("top")) : w.push("top")), n + s > b[3] && (u.indexOf(
						"bottom") >= 0 ? (n = b[3] - s, _.push("bottom")) : w.push("bottom")), i < b[0] && (u.indexOf("left") >= 0 ?
						(i = b[0], _.push("left")) : w.push("left")), i + l > b[2] && (u.indexOf("right") >= 0 ? (i = b[2] - l, _.push(
						"right")) : w.push("right")), _.length && function() {
						var e = void 0;
						e = void 0 !== t.options.pinnedClass ? t.options.pinnedClass : t.getClass("pinned"), g.push(e), _.forEach(
							function(t) {
								g.push(e + "-" + t)
							})
					}(), w.length && function() {
						var e = void 0;
						e = void 0 !== t.options.outOfBoundsClass ? t.options.outOfBoundsClass : t.getClass("out-of-bounds"), g.push(
							e), w.forEach(function(t) {
							g.push(e + "-" + t)
						})
					}(), (_.indexOf("left") >= 0 || _.indexOf("right") >= 0) && (y.left = m.left = !1), (_.indexOf("top") >= 0 ||
						_.indexOf("bottom") >= 0) && (y.top = m.top = !1), (m.top !== r.top || m.left !== r.left || y.top !== t.attachment
						.top || y.left !== t.attachment.left) && (t.updateAttachClasses(y, m), t.trigger("update", {
						attachment: y,
						targetAttachment: m
					}))
				}), D(function() {
...
function(e) {
	...
	var i = function(e, t, n) {
						...
						for (var o in r)
							if (r.hasOwnProperty(o)) {
								var s = r[o],
									a = i[o],
									l = void 0;
								if (l = a && n(a) ? "element" : t(a), !new RegExp(s).test(l)) throw new Error(e.toUpperCase() + ': Option "' +
									o + '" provided type "' + l + '" but expected type "' + s + '".')
							}
					}
				};
			return function() {
		...
		s = (function(e) {
			var t = "alert",
				...
				f = function() {
					...
					return r(t, [{
						...
						key: "_removeElement",
						value: function(t) {
							return e(t).removeClass(c.IN), o.supportsTransitionEnd() && e(t).hasClass(c.FADE) ? void e(t).one(o.TRANSITION_END,
								e.proxy(this._destroyElement, this, t)).emulateTransitionEnd(150) : void this._destroyElement(t)
						}
					}, {
						key: "_destroyElement",
						value: function(t) {
			...
			e(document).on(u.CLICK_DATA_API, l.DISMISS, f._handleDismiss(new f)), e.fn[t] = f._jQueryInterface, e.fn[t].Constructor =
				f, e.fn[t].noConflict = function() {
			...
			var t = "carousel",
				...
				g = function() {
					function a(t, i) {
						n(this, a), this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !
							1, this._config = this._getConfig(i), this._element = e(t)[0], this._indicatorsElement = e(this._element).find(
								p.INDICATORS)[0], this._addEventListeners()
					}
					return r(a, [{
						key: "next",
						value: function() {
						...
						key: "pause",
						value: function(t) {
							t || (this._isPaused = !0), e(this._element).find(p.NEXT_PREV)[0] && o.supportsTransitionEnd() && (o.triggerTransitionEnd(
						...
						value: function(t) {
							t || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config
								.interval && !this._isPaused && (this._interval = setInterval(e.proxy(document.visibilityState ? this.nextWhenVisible :
									this.next, this), this._config.interval))
						}
					}, {
						key: "to",
						value: function(t) {
						...
						key: "dispose",
						value: function() {
							e(this._element).off(s), e.removeData(this._element, i), this._items = null, this._config = null, this._element =
								null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null,
						...
						value: function() {
							this._config.keyboard && e(this._element).on(d.KEYDOWN, e.proxy(this._keydown, this)), "hover" !== this._config
								.pause || "ontouchstart" in document.documentElement || e(this._element).on(d.MOUSEENTER, e.proxy(this.pause,
									this)).on(d.MOUSELEAVE, e.proxy(this.cycle, this))
						}
					}, {
						key: "_keydown",
						value: function(e) {
						...
						value: function(t, n) {
							...
							if (!this._triggerSlideEvent(s, l).isDefaultPrevented() && r && s) {
								...
								o.supportsTransitionEnd() && e(this._element).hasClass(h.SLIDE) ? (e(s).addClass(t), o.reflow(s), e(r).addClass(
									l), e(s).addClass(l), e(r).one(o.TRANSITION_END, function() {
									e(s).removeClass(l).removeClass(t), e(s).addClass(h.ACTIVE), e(r).removeClass(h.ACTIVE).removeClass(t)
										.removeClass(l), i._isSliding = !1, setTimeout(function() {
											return e(i._element).trigger(u)
										}, 0)
								}).emulateTransitionEnd(600)) : (e(r).removeClass(h.ACTIVE), e(s).addClass(h.ACTIVE), this._isSliding = !
									1, e(this._element).trigger(u)), a && this.cycle()
							}
						}
					}], [{
						key: "_jQueryInterface",
			...
			var t = "collapse",
				...
				p = function() {
					function s(t, i) {
						n(this, s), this._isTransitioning = !1, this._element = t, this._config = this._getConfig(i), this._triggerArray =
							e.makeArray(e('[data-toggle="collapse"][href="#' + t.id + '"],[data-toggle="collapse"][data-target="#' + t.id +
					...
					return r(s, [{
						...
						value: function() {
							...
							if (!this._isTransitioning && !e(this._element).hasClass(f.IN)) {
								var n = void 0,
									r = void 0;
								if (this._parent && (n = e.makeArray(e(h.ACTIVES)), n.length || (n = null)), !(n && (r = e(n).data(i)) &&
										r._isTransitioning)) {
									var a = e.Event(c.SHOW);
									if (e(this._element).trigger(a), !a.isDefaultPrevented()) {
										n && (s._jQueryInterface.call(e(n), "hide"), r || e(n).data(i, null));
										var l = this._getDimension();
										e(this._element).removeClass(f.COLLAPSE).addClass(f.COLLAPSING), this._element.style[l] = 0, this._element
											.setAttribute("aria-expanded", !0), this._triggerArray.length && e(this._triggerArray).removeClass(f.COLLAPSED)
											.attr("aria-expanded", !0), this.setTransitioning(!0);
										var u = function() {
											e(t._element).removeClass(f.COLLAPSING).addClass(f.COLLAPSE).addClass(f.IN), t._element.style[l] = "",
												t.setTransitioning(!1), e(t._element).trigger(c.SHOWN)
										};
										if (!o.supportsTransitionEnd()) return void u();
										var d = l[0].toUpperCase() + l.slice(1),
											p = "scroll" + d;
										e(this._element).one(o.TRANSITION_END, u).emulateTransitionEnd(600), this._element.style[l] = this._element[
											p] + "px"
									}
								}
							}
						...
						value: function() {
							...
							if (!this._isTransitioning && e(this._element).hasClass(f.IN)) {
								...
								if (e(this._element).trigger(n), !n.isDefaultPrevented()) {
									...
									this._element.style[i] = this._element[r] + "px", o.reflow(this._element), e(this._element).addClass(f.COLLAPSING)
										.removeClass(f.COLLAPSE).removeClass(f.IN), this._element.setAttribute("aria-expanded", !1), this._triggerArray
										.length && e(this._triggerArray).addClass(f.COLLAPSED).attr("aria-expanded", !1), this.setTransitioning(
											!0);
									var s = function() {
										t.setTransitioning(!1), e(t._element).removeClass(f.COLLAPSING).addClass(f.COLLAPSE).trigger(c.HIDDEN)
									};
									return this._element.style[i] = 0, o.supportsTransitionEnd() ? void e(this._element).one(o.TRANSITION_END,
										s).emulateTransitionEnd(600) : void s()
								}
							}
						}
					}, {
						...
						key: "dispose",
						value: function() {
							e.removeData(this._element, i), this._config = null, this._parent = null, this._element = null, this._triggerArray =
						...
						value: function(t) {
							return this.each(function() {
								...
								if (!r && o.toggle && /show|hide/.test(t) && (o.toggle = !1), r || (r = new s(this, o), n.data(i, r)),
									"string" == typeof t) {
					...
					return r(t, [{
						...
						value: function() {
							...
							var o = {
								...
								s = e.Event(u.SHOW, o);
							return e(n).trigger(s), !s.isDefaultPrevented() && (this.focus(), this.setAttribute("aria-expanded", "true"),
								e(n).toggleClass(c.OPEN), e(n).trigger(e.Event(u.SHOWN, o)), !1)
						}
					}, {
						key: "dispose",
						value: function() {
						...
						value: function(n) {
							if (!n || 3 !== n.which) {
								...
								for (var r = e.makeArray(e(f.DATA_TOGGLE)), o = 0; o < r.length; o++) {
									...
									if (e(s).hasClass(c.OPEN) && !(n && "click" === n.type && /input|textarea/i.test(n.target.tagName) && e.contains(
											s, n.target))) {
										var l = e.Event(u.HIDE, a);
										e(s).trigger(l), l.isDefaultPrevented() || (r[o].setAttribute("aria-expanded", "false"), e(s).removeClass(
											c.OPEN).trigger(e.Event(u.HIDDEN, a)))
									}
								}
							}
						}
						...
						value: function(n) {
							if (/(38|40|27|32)/.test(n.which) && !/input|textarea/i.test(n.target.tagName) && (n.preventDefault(), n.stopPropagation(),
			...
			e(document).on(u.KEYDOWN_DATA_API, f.DATA_TOGGLE, d._dataApiKeydownHandler).on(u.KEYDOWN_DATA_API, f.ROLE_MENU, d._dataApiKeydownHandler)
				.on(u.KEYDOWN_DATA_API, f.ROLE_LISTBOX, d._dataApiKeydownHandler).on(u.CLICK_DATA_API, d._clearMenus).on(u.CLICK_DATA_API,
					f.DATA_TOGGLE, d.prototype.toggle).on(u.CLICK_DATA_API, f.FORM_CHILD, function(e) {
					e.stopPropagation()
			...
			var t = "modal",
				...
				h = function() {
					function a(t, i) {
						n(this, a), this._config = this._getConfig(i), this._element = t, this._dialog = e(t).find(d.DIALOG)[0], this._backdrop =
					...
					return r(a, [{
						...
						value: function(t) {
							...
							e(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(),
								this._setScrollbar(), e(document.body).addClass(f.OPEN), this._setEscapeEvent(), this._setResizeEvent(),
								e(this._element).on(c.CLICK_DISMISS, d.DATA_DISMISS, e.proxy(this.hide, this)), e(this._dialog).on(c.MOUSEDOWN_DISMISS,
									function() {
						...
						value: function(t) {
							t && t.preventDefault();
							var n = e.Event(c.HIDE);
							e(this._element).trigger(n), this._isShown && !n.isDefaultPrevented() && (this._isShown = !1, this._setEscapeEvent(),
								this._setResizeEvent(), e(document).off(c.FOCUSIN), e(this._element).removeClass(f.IN), e(this._element).off(
									c.CLICK_DISMISS), e(this._dialog).off(c.MOUSEDOWN_DISMISS), o.supportsTransitionEnd() && e(this._element)
								.hasClass(f.FADE) ? e(this._element).one(o.TRANSITION_END, e.proxy(this._hideModal, this)).emulateTransitionEnd(
									300) : this._hideModal())
						}
					}, {
						key: "dispose",
						value: function() {
							e.removeData(this._element, i), e(window).off(s), e(document).off(s), e(this._element).off(s), e(this._backdrop)
								.off(s), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown =
								null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._originalBodyPadding = null,
						...
						value: function(t) {
							...
							this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(
									this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this
								._element.scrollTop = 0, i && o.reflow(this._element), e(this._element).addClass(f.IN), this._config.focus &&
								this._enforceFocus();
						...
						value: function() {
							var t = this;
							this._element.style.display = "none", this._element.setAttribute("aria-hidden", "true"), this._showBackdrop(
								function() {
									e(document.body).removeClass(f.OPEN), t._resetAdjustments(), t._resetScrollbar(), e(t._element).trigger(
										c.HIDDEN)
								})
						}
					}, {
						...
						value: function(t) {
							...
							if (this._isShown && this._config.backdrop) {
								...
								if (this._backdrop = document.createElement("div"), this._backdrop.className = f.BACKDROP, i && e(this._backdrop)
									.addClass(i), e(this._backdrop).appendTo(document.body), e(this._element).on(c.CLICK_DISMISS, function(e) {
										return n._ignoreBackdropClick ? void(n._ignoreBackdropClick = !1) : void(e.target === e.currentTarget &&
								...
								o.supportsTransitionEnd() && e(this._element).hasClass(f.FADE) ? e(this._backdrop).one(o.TRANSITION_END, s)
									.emulateTransitionEnd(150) : s()
							} else t && t()
						}
					}, {
						key: "_handleUpdate",
						...
						value: function() {
							...
							this._originalBodyPadding = document.body.style.paddingRight || "", this._isBodyOverflowing && (document.body
								.style.paddingRight = t + this._scrollbarWidth + "px")
						}
					}, {
						key: "_resetScrollbar",
						value: function() {
			...
			var t = "scrollspy",
				...
				p = function() {
					function a(t, i) {
						n(this, a), this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(
								i), this._selector = this._config.target + " " + d.NAV_LINKS + "," + this._config.target + " " + d.DROPDOWN_ITEMS,
							this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, e(this._scrollElement)
							.on(c.SCROLL, e.proxy(this._process, this)), this.refresh(), this._process()
					}
					return r(a, [{
						key: "refresh",
						value: function() {
						...
						key: "dispose",
						value: function() {
							e.removeData(this._element, i), e(this._scrollElement).off(s), this._element = null, this._scrollElement =
						...
						value: function() {
							...
							for (var r = this._offsets.length; r--;) this._activeTarget !== this._targets[r] && e >= this._offsets[r] &&
								(void 0 === this._offsets[r + 1] || e < this._offsets[r + 1]) && this._activate(this._targets[r])
						}
					}, {
						key: "_activate",
						value: function(t) {
							...
							var i = e(n.join(","));
							i.hasClass(f.DROPDOWN_ITEM) ? (i.closest(d.DROPDOWN).find(d.DROPDOWN_TOGGLE).addClass(f.ACTIVE), i.addClass(
								f.ACTIVE)) : i.parents(d.LI).find(d.NAV_LINKS).addClass(f.ACTIVE), e(this._scrollElement).trigger(c.ACTIVATE, {
								relatedTarget: t
							})
						}
					}, {
				...
				f = function() {
					...
					return r(t, [{
						...
						value: function(t, n, i, r) {
							...
							if (e(t).addClass(u.ACTIVE), t.setAttribute("aria-expanded", !0), i ? (o.reflow(t), e(t).addClass(u.IN)) :
								e(t).removeClass(u.FADE), t.parentNode && e(t.parentNode).hasClass(u.DROPDOWN_MENU)) {
			...
			if (void 0 === window.Tether) throw new Error(
			...
			var t = "tooltip",
				...
				m = function() {
					function a(e, t) {
						n(this, a), this._isEnabled = !0, this._timeout = 0, this._hoverState = "", this._activeTrigger = {}, this._tether =
							null, this.element = e, this.config = this._getConfig(t), this.tip = null, this._setListeners()
					}
					return r(a, [{
						key: "enable",
						value: function() {
						...
						value: function(t) {
							if (t) {
								...
								i || (i = new this.constructor(t.currentTarget, this._getDelegateConfig()), e(t.currentTarget).data(n, i)),
									i._activeTrigger.click = !i._activeTrigger.click, i._isWithActiveTrigger() ? i._enter(null, i) : i._leave(
										null, i)
							} else {
						...
						key: "dispose",
						value: function() {
							clearTimeout(this._timeout), this.cleanupTether(), e.removeData(this.element, this.constructor.DATA_KEY), e(
									this.element).off(this.constructor.EVENT_KEY), this.tip && e(this.tip).remove(), this._isEnabled = null,
								this._timeout = null, this._hoverState = null, this._activeTrigger = null, this._tether = null, this.element =
						...
						value: function() {
							...
							if (this.isWithContent() && this._isEnabled) {
								...
								r.setAttribute("id", s), this.element.setAttribute("aria-describedby", s), this.setContent(), this.config.animation &&
									e(r).addClass(h.FADE);
								var l = "function" == typeof this.config.placement ? this.config.placement.call(this, r, this.element) :
									this.config.placement,
									u = this._getAttachment(l);
								e(r).data(this.constructor.DATA_KEY, this).appendTo(document.body), e(this.element).trigger(this.constructor
									.Event.INSERTED), this._tether = new Tether({
									attachment: u,
									element: r,
									target: this.element,
									classes: g,
								...
								if (o.supportsTransitionEnd() && e(this.tip).hasClass(h.FADE)) return void e(this.tip).one(o.TRANSITION_END,
									c).emulateTransitionEnd(a._TRANSITION_DURATION);
								c()
							}
						}
					}, {
						...
						value: function(t) {
							var n = this,
								...
								s = function() {
									n._hoverState !== f.IN && i.parentNode && i.parentNode.removeChild(i), n.element.removeAttribute(
										"aria-describedby"), e(n.element).trigger(n.constructor.Event.HIDDEN), n.cleanupTether(), t && t()
								};
							e(this.element).trigger(r), r.isDefaultPrevented() || (e(i).removeClass(h.IN), o.supportsTransitionEnd() &&
								e(this.tip).hasClass(h.FADE) ? e(i).one(o.TRANSITION_END, s).emulateTransitionEnd(150) : s(), this._hoverState =
								"")
						}
					}, {
						key: "isWithContent",
						...
						value: function() {
							...
							this.setElementContent(t.find(p.TOOLTIP_INNER), this.getTitle()), t.removeClass(h.FADE).removeClass(h.IN),
								this.cleanupTether()
						}
					}, {
						...
						value: function(t, n) {
							...
							"object" == typeof n && (n.nodeType || n.jquery) ? i ? e(n).parent().is(t) || t.empty().append(n) : t.text(
								e(n).text()) : t[i ? "html" : "text"](n)
						}
					}, {
						key: "getTitle",
						value: function() {
							var e = this.element.getAttribute("data-original-title");
							return e || (e = "function" == typeof this.config.title ? this.config.title.call(this.element) : this.config
								.title), e
						}
					}, {
						key: "cleanupTether",
						...
						value: function() {
							...
							this.config.trigger.split(" ").forEach(function(n) {
								if ("click" === n) e(t.element).on(t.constructor.Event.CLICK, t.config.selector, e.proxy(t.toggle, t));
									...
									e(t.element).on(i, t.config.selector, e.proxy(t._enter, t)).on(r, t.config.selector, e.proxy(t._leave,
										t))
								}
						...
						value: function(t, n) {
							...
							return n = n || e(t.currentTarget).data(i), n || (n = new this.constructor(t.currentTarget, this._getDelegateConfig()),
								e(t.currentTarget).data(i, n)), t && (n._activeTrigger["focusin" === t.type ? v.FOCUS : v.HOVER] = !0), e(
								n.getTipElement()).hasClass(h.IN) || n._hoverState === f.IN ? void(n._hoverState = f.IN) : (clearTimeout(
								n._timeout), n._hoverState = f.IN, n.config.delay && n.config.delay.show ? void(n._timeout = setTimeout(
								function() {
						...
						value: function(t, n) {
							...
							if (n = n || e(t.currentTarget).data(i), n || (n = new this.constructor(t.currentTarget, this._getDelegateConfig()),
									e(t.currentTarget).data(i, n)), t && (n._activeTrigger["focusout" === t.type ? v.FOCUS : v.HOVER] = !1),
								!n._isWithActiveTrigger()) return clearTimeout(n._timeout), n._hoverState = f.OUT, n.config.delay && n.config
								.delay.hide ? void(n._timeout = setTimeout(function() {
						...
						key: "_getConfig",
						value: function(n) {
							return n = e.extend({}, this.constructor.Default, e(this.element).data(), n), n.delay && "number" == typeof n
								.delay && (n.delay = {
									show: n.delay,
									hide: n.delay
		...
		var o = "popover",
			...
			g = function(s) {
				...
				return t(u, s), r(u, [{
					...
					value: function() {
						var t = e(this.getTipElement());
						this.setElementContent(t.find(h.TITLE), this.getTitle()), this.setElementContent(t.find(h.CONTENT), this._getContent()),
							t.removeClass(d.FADE).removeClass(d.IN), this.cleanupTether()
					}
				}, {
					key: "_getContent",
					value: function() {
...
function(e, t) {
	...
	var n = babelHelpers.interopRequireDefault(t),
		i = function() {
			function e(t) {
				babelHelpers.classCallCheck(this, e), this._states = Object.assign({}, t), this._values = {}, this._relations = {},
					this._callbacks = {}, this._define()
			}
			return babelHelpers.createClass(e, [{
				key: "_define",
				value: function() {
					for (var e = this, t = this, n = Object.keys(this._states), i = {}, r = [], o = [], s = 0, a = n.length; s <
						a; s++) ! function(s, a) {
						var l = n[s];
				...
				key: "on",
				value: function(e, t) {
					"function" == typeof e && (t = e, e = "all"), this._callbacks[e] || (this._callbacks[e] = n.default.Callbacks()),
				...
				value: function(e, t) {
					...
					if ("string" == typeof e && void 0 !== t && "function" != typeof this._states[e]) this._states[e] = t, n ||
						this._compare(e);
...
function(e, t) {
	...
	var o = function() {
		function e() {
			...
			babelHelpers.classCallCheck(this, e), this.$el = t.$el ? t.$el : (0, i.default)(document), this.el = this.$el[0],
				delete t.$el, this.children = this.getDefaultChildren(), this.actions = this.getDefaultActions(), this.initialState =
				this.getDefaultState(), this._willProcess = i.default.Callbacks(), this._processed = i.default.Callbacks(), this.willProcess &&
				this._willProcess.add(this.willProcess), this.processed && this._processed.add(this.processed), this.isProcessed = !
				1, this.mix(t), this.state = null
		}
		return babelHelpers.createClass(e, [{
			...
			value: function(e) {
				...
				for (var t = 0, n = this.children.length; t < n; t++) this.children[t]._process(this.state), this.children[t]
					.isProcessed = !0;
			...
			value: function() {
				...
				if (!this.isInit) {
					...
					return n = n.filter(function(e) {
						...
						}), this.children = [].concat(babelHelpers.toConsumableArray(this.children), babelHelpers.toConsumableArray(
							n)), this.actions = Object.assign({}, this.actions, r), this.initialState = Object.assign({}, this.initialState,
							s), this.initialState = this._combineInitialState(), "function" != typeof l && this._willProcess.add(l),
						"function" != typeof c && this._processed.add(c), delete e.children, delete e.actions, delete e.state,
						delete e.willProcess, delete e.processed, Object.assign(this, e), this
				}
			}
		}, {
			key: "triggerResize",
	...
	var s = babelHelpers.interopRequireDefault(t),
		...
		u = function() {
			function e(t) {
				...
				babelHelpers.classCallCheck(this, e), this.name = this.getName(), this.$el = t, this.options = n, this.isRendered = !
					1
			}
			return babelHelpers.createClass(e, [{
				key: "getName",
					...
					"string" == typeof n ? function() {
						var n = t.api().split("|"),
							...
							a = function(n) {
								...
								a || (a = new t(i, s.default.extend(!0, {}, r(e), i.data())), a.initialize(), i.data("pluginInstance", a)),
									a[o](n)
							};
						l[e] = function(e, t) {
...
function(e, t) {
	...
	var r = babelHelpers.interopRequireDefault(t),
		...
		s = function(e) {
			function t() {
				return babelHelpers.classCallCheck(this, t), babelHelpers.possibleConstructorReturn(this, (t.__proto__ || Object.getPrototypeOf(
...
function(e, t) {
	...
	function n(e, t) {
		"string" == typeof e && void 0 !== t ? o[e] = t : "object" === (void 0 === e ? "undefined" : babelHelpers.typeof(e)) &&
			(o = $.extend(!0, {}, o, e))
	}
			...
			return babelHelpers.inherits(t, e), babelHelpers.createClass(t, [{
				...
				value: function() {
					if (navigator.userAgent.match(/IEMobile\/10\.0/)) {
						...
						e.appendChild(l.createTextNode("@-ms-viewport{width:auto!important}")), l.querySelector("head").appendChild(
							e)
					}
				}
			}]), t
...
function(e, t) {
		...
		l = function() {
			...
			return r(e, [{
				...
				value: function(e, t) {
					...
					t || (t = this.length - 1);
					var i = this.list[t];
					a.isFunction(n) ? n.call(this, e, i, t) : a.isFunction(i.fn) && i.fn.call(e || window, i.data), i.one && (
						delete this.list[t], this.length--)
				}
			}, {
				key: "fire",
				value: function(e) {
		...
		c = function() {
			...
			return r(e, [{
				...
				value: function(e, t, n) {
					...
					return void 0 === n && a.isFunction(t) && (n = t, t = void 0), a.isFunction(n) ? (void 0 !== this.callbacks[e] &&
							(this.callbacks[e].add(n, t, i), "enter" === e && this.isMatched() && this.callbacks[e].call(this)), this) :
						this
				}
			}, {
				key: "one",
				...
				value: function(e, t) {
					...
					return void 0 === e ? (this.callbacks.enter.empty(), this.callbacks.leave.empty()) : e in this.callbacks && (
						t ? this.callbacks[e].remove(t) : this.callbacks[e].empty()), this
				}
			}, {
				key: "isMatched",
				value: function() {
	...
	e.default = y
		...
		var c, f, d = {},
			...
			O = function(e, n, i, r) {
				...
				return o = ["&#173;", '<style id="s', p, '">', e, "</style>"].join(""), u.id = p, (c ? u : f).innerHTML += o, f.appendChild(
					u), c || (f.style.background = "", f.style.overflow = "hidden", l = h.style.overflow, h.style.overflow = "hidden",
					h.appendChild(f)), s = n(u, e), c ? u.parentNode.removeChild(u) : (f.parentNode.removeChild(f), h.style.overflow =
					l), !!s
			},
			D = function() {
				function e(e, r) {
					...
					var s = e in r;
					return s || (r.setAttribute || (r = t.createElement("div")), r.setAttribute && r.removeAttribute && (r.setAttribute(
						e, ""), s = o(r[e], "function"), o(r[e], "undefined") || (r[e] = n), r.removeAttribute(e))), r = null, s
				}
				var i = {
					select: "input",
					change: "input",
		...
		f = o(N, "undefined") || o(N.call, "undefined") ? function(e, t) {
			...
			var n;
			return "ontouchstart" in e || e.DocumentTouch && t instanceof DocumentTouch ? n = !0 : O(["@media (", _.join(
				"touch-enabled),("), p, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function(e) {
				n = 9 === e.offsetTop
			}), n
			...
			return i((e + "-webkit- ".split(" ").join("gradient(linear,left top,right bottom,from(#9f9),to(white));" + e) + _.join(
				"linear-gradient(left top,#9f9, white);" + e)).slice(0, -e.length)), s(v.backgroundImage, "gradient")
			...
			var e = !!u("perspective");
			return e && "webkitPerspective" in h.style && O(
		...
		return d.input || function() {
				d.input = function(n) {
					...
					}("autocomplete autofocus list placeholder max min multiple pattern required step".split(" ")), d.inputtypes =
					function(e) {
						for (var i, r, o, s = 0, a = e.length; s < a; s++) m.setAttribute("type", r = e[s]), i = "text" !== m.type, i &&
							(m.value = y, m.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(r) && m.style.WebkitAppearance !==
								n ? (h.appendChild(m), o = t.defaultView, i = o.getComputedStyle && "textfield" !== o.getComputedStyle(m, null)
									.WebkitAppearance && 0 !== m.offsetHeight, h.removeChild(m)) : /^(search|tel)$/.test(r) || (i =
									/^(url|email)$/.test(r) ? m.checkValidity && !1 === m.checkValidity() : m.value != y)), A[e[s]] = !!i;
						return A
			...
			function(e, t) {
				...
				function o(e, n, i) {
					...
					i || (i = r(n));
					var o;
					return o = i.cache[e] ? i.cache[e].cloneNode() : h.test(e) ? (i.cache[e] = i.createElem(e)).cloneNode() : i.createElem(
						e), !o.canHaveChildren || d.test(e) || o.tagUrn ? o : i.frag.appendChild(o)
				}
				...
				function a(e, t) {
					t.cache || (t.cache = {}, t.createElem = e.createElement, t.createFrag = e.createDocumentFragment, t.frag = t.createFrag()),
						e.createElement = function(n) {
							...
							"return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&(" + i().join().replace(/[\w\-]+/g,
								function(e) {
				...
				function l(e) {
					e || (e = t);
					var i = r(e);
					return m.shivCSS && !u && !i.hasCSS && (i.hasCSS = !!n(e,
				...
				e.html5 = m, l(t)
			}(this, t), d._version = "2.8.3", d._prefixes = _, d._domPrefixes = x, d._cssomPrefixes = E, d.hasEvent = D, d.testProp =
			function(e) {
				return a([e])
	...
	function(e, t, n) {
		...
		function l(e, n, i, r, o, l, u) {
			...
			1 === A[n] && (v = 1, A[n] = []), "object" == e ? f.data = n : (f.src = n, f.type = e), f.width = f.height = "0", f.onerror =
		...
		function u(e, t, n, i, o) {
			return y = 0, t = t || "j", r(e) ? l("c" == t ? x : E, e, t, this.i++, n, i, o) : (m.splice(this.i++, 0, e), 1 == m.length &&
				a()), this
		}
		...
		d = function(e) {
			...
			function s(e, r, o, s, a) {
				var l = t(e),
					u = l.autoCallback;
				l.url.split(".").pop().split("?").shift(), l.bypass || (r && (r = i(r) ? r : r[e] || r[s] || r[e.split("/").pop().split(
					"?")[0]]), l.instead ? l.instead(e, r, o, s, a) : (A[l.url] ? l.noexec = !0 : A[l.url] = 1, o.load(l.url, l.forceCSS ||
					!l.forceJS && "css" == l.url.split(".").pop().split("?").shift() ? "c" : n, l.noexec, l.attrs, l.timeout), (i(
					r) || i(u)) && o.load(function() {
	...
	}, window.MSTR = $('meta[name="generator"]').data("variable").split("|"), window.M = [], M.weburl = MSTR[0], M.lang =
	MSTR[1], M.synchronous = "undefined" != typeof MET && MET.langset ? MET.langset : MSTR[2], M.tem = MSTR[0] +
	"templates/" + MSTR[3] + "/", M.module = "" == MSTR[4] ? MSTR[4] : parseInt(MSTR[4]), M.classnow = "" == MSTR[5] ?
	MSTR[5] : parseInt(MSTR[5]), M.id = "" == MSTR[6] ? MSTR[6] : parseInt(MSTR[6]), M.qilincms_version = $(
		'meta[name="generator"]').length ? $('meta[name="generator"]').attr("content").replace("QilinCms ", "").replace(/\./g,
		"") : "qilincms", M.user_name = $('meta[name="generator"]').data("user_name") || "", M.time = (new Date).getTime(), M.useragent =
	navigator.userAgent, M.useragent_tlc = M.useragent.toLowerCase(), M.device_type = device_type = /iPad/.test(M.useragent) ?
	"t" : /Mobile|iP(hone|od)|Android|BlackBerry|IEMobile|Silk/.test(M.useragent) ? "m" : "d",
	M.is_ucbro = /UC/.test(M.useragent), M.is_lteie9 = !1, M.is_ie10 = !1, new RegExp("msie").test(M.useragent_tlc) && (M.iebrowser_ver =
		(M.useragent_tlc.match(/.+(?:rv|it|ra|ie)[\/: ]([\d.]+)/) || [0, "0"])[1], 10 == M.iebrowser_ver && (M.is_ie10 = !0),
		M.iebrowser_ver < 10 && (M.is_lteie9 = !0)), window.met_lazyloadbg = $("input[name=met_lazyloadbg]").val() || M.weburl +
	"static/site/pc/images/loading.gif", met_lazyloadbg.indexOf(M.weburl) < 0 && met_lazyloadbg.indexOf("http") < 0 &&
	met_lazyloadbg.indexOf("../") < 0 && (met_lazyloadbg = M.weburl + met_lazyloadbg), (met_lazyloadbg == M.weburl ||
		met_lazyloadbg.indexOf(".png") < 0 && met_lazyloadbg.indexOf(".gif") < 0 && met_lazyloadbg.indexOf(".jpg") < 0) && (
		met_lazyloadbg = M.weburl + "static/site/pc/images/loading.gif"), (window.ActiveXObject || "ActiveXObject" in
		window || M.is_ucbro) && (met_lazyloadbg = "base64"), M.lazyloadbg = met_lazyloadbg, "undefined" != typeof Breakpoints &&
	Breakpoints(),
	function(e, t, n) {
		"use strict";
		...
		n(function() {
			void 0 !== i && i.run(), n(e).on("click", ".modal-dialog.modal-center", function(e) {
				n(e.target).closest(".modal-dialog.modal-center .modal-content").length || n(this).parents(".modal:eq(0)").attr(
					"data-backdrop") || n(this).parents(".modal:eq(0)").modal("hide")
			}), Breakpoints.on("xs", {
				enter: function() {
				...
				n(".modal-dialog", this).hasClass("modal-center") && n(".modal-content", this).outerHeight() > n(t).height() &&
					n(".modal-dialog", this).removeClass("modal-center")
			}), n(e).on("hidden.bs.modal", ".modal", function(e) {
				n("form", this).each(function(e, t) {
					n(this).data("formValidation").resetForm()
				}), n(".modal.in").length && n("body").addClass("modal-open")
			})
		})
		...
		includeFile: function(e, t, n, i, r) {
			var o = e.replace(/^\s|\s$/g, ""),
				...
				l = function() {
					includeFileIndex++, includeFileIndex < n ? $.includeFile(includeFile[includeFileIndex], t, n, i, r) : ("siterun" ==
						r && void 0 !== window.Site && Site.run(), "function" == typeof i && i())
				};
			if (includeFileIndex >= t && includeFileIndex < n) {
				if ("js" == a[0]) {
					var u = document.createElement("script"),
						c = o;
					if (u.src = c, u.type = "text/javascript", file_index = $.inArray(o, includeFile), includeFileIndex > file_index)
						l();
					else {
						if (!($('script[src="' + c + '"]').length && includeFileIndex == file_index || !$('script[src="' + c + '"]').length &&
								void 0 !== u)) return setTimeout(function() {
					...
					var u = document.createElement("link"),
						f = o;
					u.href = f, u.type = "text/css", u.rel = "stylesheet", $('link[href="' + f + '"]').length || void 0 === u ||
						document.getElementsByTagName("head")[0].appendChild(u), $('link[href="' + f + '"]').length && l()
				}
		...
		var r = $(".sidebar-piclist-ul");
		r.find(".masonry-child").length > 1 && "function" == typeof $.fn.masonry && Breakpoints.on("xs sm", {
			enter: function() {
				r.masonry({
					itemSelector: ".masonry-child"
				})
			}
		}), !$(".metvideobox").length || $('link[href*="video-js.css"]').length || $(".metvideobox .metvideo").length || ($(
			".metvideobox").each(function() {
			var e = $(this).attr("data-metvideo").split("|"),
				t = e[0],
				n = e[1],
				i = e[2],
				r = e[3] || !1,
				...
				t + '" height="' + n + '" poster="' + i + '" data-setup=\'{"autoplay":' + r +
				'}\' webkit-playsinline playsinline x5-playsinline x-webkit-airplay="allow" x5-video-player-type="h5" x5-video-player-fullscreen><source src="' +
				o + '" type="video/mp4" /></video></div>';
			$(this).after(s).remove()
		}), $.include(M.weburl + "public/ui/v1/js/effects/video-js/video-js.css"), "d" == M.device_type ? $.include(M.weburl +
		...
		navtabSwiper: function() {
			var e = $(this),
				...
				n = function() {
					...
					e.find(">li").parentWidth() > e.parent().width() ? (e.hasClass("swiper-wrapper") ? e.hasClass("flex-start") || e
						.addClass("flex-start") : (e.addClass("swiper-wrapper flex-start").wrap(
							'<div class="swiper-container swiper-navtab"></div>').after('<div class="swiper-scrollbar"></div>').find(
							">li").addClass("swiper-slide"), new Swiper(".swiper-navtab", {
							slidesPerView: "auto",
							...
							"margin-bottom": 10
						}), e.find(".dropdown").length && $(".swiper-navtab").length && ($(".swiper-navtab").hasClass(
							"overflow-visible") || $(".swiper-navtab").addClass("overflow-visible"))) : e.hasClass("flex-start") && (e.removeClass(
						"flex-start"), t.css({
						"margin-bottom": 0
					}))
				};
			n(), $(window).resize(function() {
				...
				enter: function() {
					e.find(".dropdown-menu").each(function() {
						$(this).parent("li").offset().left > $(window).width() / 2 - $(this).parent("li").width() / 2 && $(this).addClass(
							"dropdown-menu-right")
					})
				}
			})
		...
		imageloadFunAlone: function(e) {
			var t = new Image;
			if (t.src = $(this).data("original") || $(this).data("lazy") || $(this).attr("src"), t.complete) return void(
			...
			$(this).each(function() {
				if ($(this).data("lazy") || $(this).data("original")) var t = $(this),
					n = setInterval(function() {
						t.attr("src") != t.data("original") && t.attr("src") != t.data("lazy") || (clearInterval(n), t.imageloadFunAlone(
							e))
					}, 100);
			...
			$(this).each(function() {
				...
				if (i.length && t.indexOf("x") >= 0) {
					...
					$(window).resize(function() {
						i.each(function() {
							$(this).is(":visible") && $(this).data("original") && $(this).attr("src") != $(this).data("original") &&
								$(this).height(Math.round($(this).width() * t))
						})
					}), i.each(function() {
						var e = $(this);
		...
		videoSizeRes: function() {
			$(this).each(function() {
				var e = $(this),
					...
					n = $(this).width();
				t || (t = parseInt($(this).css("height")) / parseInt($(this).css("width"))), t && ($(this).height($(this).width() *
...
try{ 
    ...
    console.log('isSimplified error:'+err);
    var isSimplified = 1;
}

$(document).on("click", ".onlinebox-open", function(e) {
	e.preventDefault(), $('#onlinebox').removeClass("min"), $(this).hide()
});

$(document).on("click", ".onlinebox-min", function(e) {
	e.preventDefault(), $('#onlinebox').addClass("min"), $(".onlinebox-open").show()
});

$(document).on("click", ".onlinebox-close", function(e) {
	e.preventDefault(), $('#onlinebox').hide()
});

$(document).ready(function () {
    var menuYloc = $("#onlinebox").offset().top;
    $(window).scroll(function () {
        var offsetTop = menuYloc + $(window).scrollTop() + "px";
        $("#onlinebox").animate({ top: offsetTop }, { duration: 400, queue: false });
    });
});

window.METUI = [], window.METUI_FUN = [];
// window.METUI = [], window.METUI_FUN = [], $("#met-page-js").data("js_url").indexOf(".js") >= 0 && $("body").append(
// 	'<script src="' + $("#met-page-js").data("js_url") + '"><\/script>'), $(function() {
// 	if (M.module && M.id) {
// 		switch (M.module) {
// 			case 2:
// 				M.module_name = "news";
...
// 				M.module_name = "img"
// 		}
// 		void 0 === M.module_name || $('script[src*="/hits/?lang="]').length || $.ajax({
// 			type: "GET",
// 			dataType: "text",
...
// 		dataType: "json",
// 		success: function(e) {
// 			if (e.t = parseInt(e.t), e.t) {
// 				$.include(M.weburl + "/Public/Web/css/online.css"), e.html = e.html.replace(" onclick='return onlineclose();'", "").replace(" onclick='return onlinemin();'", ""), $("body").append(e.html);
